...
// fifo_new: Allocate and initialize fifo structure. Add an empty item to the fifo.
...
// fifo_free: Delete all items and free fifo structure.
...
// fifo_pop: Extract item from queue. Returns NULL on empty queue.
