...
inline const char *EnumNameCode(Code e) {
  if (flatbuffers::IsOutRange(e, Code::RUNTIME_EXCEPTION, Code::RUNTIME_FUNCTION_EXCEPTION)) return "";
...
inline const char *EnumNameStoragePermissionRead(StoragePermissionRead e) {
  if (flatbuffers::IsOutRange(e, StoragePermissionRead::NO_READ, StoragePermissionRead::PUBLIC_READ)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameStoragePermissionWrite(StoragePermissionWrite e) {
  if (flatbuffers::IsOutRange(e, StoragePermissionWrite::NO_WRITE, StoragePermissionWrite::OWNER_WRITE)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline const char *EnumNameUpdateOpCode(UpdateOpCode e) {
  if (flatbuffers::IsOutRange(e, UpdateOpCode::ADD, UpdateOpCode::COMPARE)) return "";
  const size_t index = static_cast<size_t>(e);
...
inline void Error::UnPackTo(ErrorT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = message(); if (_e) _o->message = CharString(_e->c_str(), _e->size()); }
}
...
inline void AuthenticateRequest::UnPackTo(AuthenticateRequestT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = collation_id(); if (_e) _o->collation_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = id(); if (_e) _o->id = std::unique_ptr<server::AuthenticateRequest_::AuthenticateMethodT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<AuthenticateRequest> CreateAuthenticateRequest(flatbuffers::FlatBufferBuilder &_fbb, const AuthenticateRequestT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const AuthenticateRequestT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline Dictionary AuthenticateRequest::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  Dictionary _o ;
  { auto _e = collation_id(); if (_e) _o["collation_id"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = id(); if (_e) _o["id"] = _e->UnPackToDict(_resolver); }
  return _o;
}
...
inline void Email::UnPackTo(EmailT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = email(); if (_e) _o->email = CharString(_e->c_str(), _e->size()); }
  { auto _e = password(); if (_e) _o->password = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<Email> CreateEmail(flatbuffers::FlatBufferBuilder &_fbb, const EmailT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const EmailT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void GameCenter::UnPackTo(GameCenterT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = player_id(); if (_e) _o->player_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = bundle_id(); if (_e) _o->bundle_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = timestamp(); _o->timestamp = _e; }
  { auto _e = salt(); if (_e) _o->salt = CharString(_e->c_str(), _e->size()); }
  { auto _e = signature(); if (_e) _o->signature = CharString(_e->c_str(), _e->size()); }
  { auto _e = public_key_url(); if (_e) _o->public_key_url = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<GameCenter> CreateGameCenter(flatbuffers::FlatBufferBuilder &_fbb, const GameCenterT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const GameCenterT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void AuthenticateMethod::UnPackTo(AuthenticateMethodT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = email(); if (_e) _o->email = std::unique_ptr<server::AuthenticateRequest_::EmailT>(_e->UnPack(_resolver)); }
  { auto _e = facebook(); if (_e) _o->facebook = CharString(_e->c_str(), _e->size()); }
  { auto _e = google(); if (_e) _o->google = CharString(_e->c_str(), _e->size()); }
  { auto _e = game_center(); if (_e) _o->game_center = std::unique_ptr<server::AuthenticateRequest_::GameCenterT>(_e->UnPack(_resolver)); }
  { auto _e = steam(); if (_e) _o->steam = CharString(_e->c_str(), _e->size()); }
  { auto _e = device(); if (_e) _o->device = CharString(_e->c_str(), _e->size()); }
  { auto _e = custom(); if (_e) _o->custom = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<AuthenticateMethod> CreateAuthenticateMethod(flatbuffers::FlatBufferBuilder &_fbb, const AuthenticateMethodT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const AuthenticateMethodT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline Dictionary AuthenticateMethod::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = email(); if (_e) _o["email"] = _e->UnPackToDict(_resolver); }
  { auto _e = facebook(); if (_e) _o["facebook"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = google(); if (_e) _o["google"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = game_center(); if (_e) _o["game_center"] = _e->UnPackToDict(_resolver); }
  { auto _e = steam(); if (_e) _o["steam"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = device(); if (_e) _o["device"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = custom(); if (_e) _o["custom"] = CharString(_e->c_str(), _e->size()); }
  return _o;
...
inline void AuthenticateResponse::UnPackTo(AuthenticateResponseT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = collation_id(); if (_e) _o->collation_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = id(); if (_e) _o->id = std::unique_ptr<server::AuthenticateResponse_::AuthenticateResultT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<AuthenticateResponse> CreateAuthenticateResponse(flatbuffers::FlatBufferBuilder &_fbb, const AuthenticateResponseT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const AuthenticateResponseT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _collation_id = _o->collation_id.empty() ? 0 : _fbb.CreateString(_o->collation_id);
...
inline void Session::UnPackTo(SessionT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = token(); if (_e) _o->token = CharString(_e->c_str(), _e->size()); }
  { auto _e = udp_token(); if (_e) _o->udp_token = CharString(_e->c_str(), _e->size()); }
}
...
inline void Error::UnPackTo(ErrorT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = code(); _o->code = _e; }
  { auto _e = message(); if (_e) _o->message = CharString(_e->c_str(), _e->size()); }
  { auto _e = request(); if (_e) _o->request = std::unique_ptr<server::AuthenticateRequestT>(_e->UnPack(_resolver)); }
}
...
inline Dictionary Error::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = code(); _o["code"] = _e; }
  { auto _e = message(); if (_e) _o["message"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = request(); if (_e) _o["request"] = _e->UnPackToDict(_resolver); }
  return _o;
}
...
inline void AuthenticateResult::UnPackTo(AuthenticateResultT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = session(); if (_e) _o->session = std::unique_ptr<server::AuthenticateResponse_::SessionT>(_e->UnPack(_resolver)); }
  { auto _e = error(); if (_e) _o->error = std::unique_ptr<server::AuthenticateResponse_::ErrorT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<AuthenticateResult> CreateAuthenticateResult(flatbuffers::FlatBufferBuilder &_fbb, const AuthenticateResultT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const AuthenticateResultT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline Dictionary AuthenticateResult::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = session(); if (_e) _o["session"] = _e->UnPackToDict(_resolver); }
  { auto _e = error(); if (_e) _o["error"] = _e->UnPackToDict(_resolver); }
  return _o;
}
...
inline void Envelope::UnPackTo(EnvelopeT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = collation_id(); if (_e) _o->collation_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = payload(); if (_e) _o->payload = std::unique_ptr<server::Envelope_::EnvelopeContentT>(_e->UnPack(_resolver)); }
}
...
inline Dictionary Envelope::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  Dictionary _o ;
  { auto _e = collation_id(); if (_e) _o["collation_id"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = payload(); if (_e) _o["payload"] = _e->UnPackToDict(_resolver); }
  return _o;
}
...
inline void EnvelopeContent::UnPackTo(EnvelopeContentT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = error(); if (_e) _o->error = std::unique_ptr<server::ErrorT>(_e->UnPack(_resolver)); }
  { auto _e = heartbeat(); if (_e) _o->heartbeat = std::unique_ptr<server::HeartbeatT>(_e->UnPack(_resolver)); }
  { auto _e = logout(); if (_e) _o->logout = std::unique_ptr<server::LogoutT>(_e->UnPack(_resolver)); }
  { auto _e = link(); if (_e) _o->link = std::unique_ptr<server::TLinkT>(_e->UnPack(_resolver)); }
  { auto _e = unlink(); if (_e) _o->unlink = std::unique_ptr<server::TUnlinkT>(_e->UnPack(_resolver)); }
  { auto _e = self_fetch(); if (_e) _o->self_fetch = std::unique_ptr<server::TSelfFetchT>(_e->UnPack(_resolver)); }
  { auto _e = self_update(); if (_e) _o->self_update = std::unique_ptr<server::TSelfUpdateT>(_e->UnPack(_resolver)); }
  { auto _e = users_fetch(); if (_e) _o->users_fetch = std::unique_ptr<server::TUsersFetchT>(_e->UnPack(_resolver)); }
  { auto _e = self(); if (_e) _o->self = std::unique_ptr<server::TSelfT>(_e->UnPack(_resolver)); }
  { auto _e = users(); if (_e) _o->users = std::unique_ptr<server::TUsersT>(_e->UnPack(_resolver)); }
  { auto _e = friends_add(); if (_e) _o->friends_add = std::unique_ptr<server::TFriendsAddT>(_e->UnPack(_resolver)); }
  { auto _e = friends_remove(); if (_e) _o->friends_remove = std::unique_ptr<server::TFriendsRemoveT>(_e->UnPack(_resolver)); }
  { auto _e = friends_block(); if (_e) _o->friends_block = std::unique_ptr<server::TFriendsBlockT>(_e->UnPack(_resolver)); }
  { auto _e = friends_list(); if (_e) _o->friends_list = std::unique_ptr<server::TFriendsListT>(_e->UnPack(_resolver)); }
  { auto _e = friends(); if (_e) _o->friends = std::unique_ptr<server::TFriendsT>(_e->UnPack(_resolver)); }
  { auto _e = groups_create(); if (_e) _o->groups_create = std::unique_ptr<server::TGroupsCreateT>(_e->UnPack(_resolver)); }
  { auto _e = groups_update(); if (_e) _o->groups_update = std::unique_ptr<server::TGroupsUpdateT>(_e->UnPack(_resolver)); }
  { auto _e = groups_remove(); if (_e) _o->groups_remove = std::unique_ptr<server::TGroupsRemoveT>(_e->UnPack(_resolver)); }
  { auto _e = groups_fetch(); if (_e) _o->groups_fetch = std::unique_ptr<server::TGroupsFetchT>(_e->UnPack(_resolver)); }
  { auto _e = groups_list(); if (_e) _o->groups_list = std::unique_ptr<server::TGroupsListT>(_e->UnPack(_resolver)); }
  { auto _e = groups_self_list(); if (_e) _o->groups_self_list = std::unique_ptr<server::TGroupsSelfListT>(_e->UnPack(_resolver)); }
  { auto _e = group_users_list(); if (_e) _o->group_users_list = std::unique_ptr<server::TGroupUsersListT>(_e->UnPack(_resolver)); }
  { auto _e = groups_join(); if (_e) _o->groups_join = std::unique_ptr<server::TGroupsJoinT>(_e->UnPack(_resolver)); }
  { auto _e = groups_leave(); if (_e) _o->groups_leave = std::unique_ptr<server::TGroupsLeaveT>(_e->UnPack(_resolver)); }
  { auto _e = group_users_add(); if (_e) _o->group_users_add = std::unique_ptr<server::TGroupUsersAddT>(_e->UnPack(_resolver)); }
  { auto _e = group_users_kick(); if (_e) _o->group_users_kick = std::unique_ptr<server::TGroupUsersKickT>(_e->UnPack(_resolver)); }
  { auto _e = group_users_promote(); if (_e) _o->group_users_promote = std::unique_ptr<server::TGroupUsersPromoteT>(_e->UnPack(_resolver)); }
  { auto _e = groups(); if (_e) _o->groups = std::unique_ptr<server::TGroupsT>(_e->UnPack(_resolver)); }
  { auto _e = groups_self(); if (_e) _o->groups_self = std::unique_ptr<server::TGroupsSelfT>(_e->UnPack(_resolver)); }
  { auto _e = group_users(); if (_e) _o->group_users = std::unique_ptr<server::TGroupUsersT>(_e->UnPack(_resolver)); }
  { auto _e = topics_join(); if (_e) _o->topics_join = std::unique_ptr<server::TTopicsJoinT>(_e->UnPack(_resolver)); }
  { auto _e = topics_leave(); if (_e) _o->topics_leave = std::unique_ptr<server::TTopicsLeaveT>(_e->UnPack(_resolver)); }
  { auto _e = topic_message_send(); if (_e) _o->topic_message_send = std::unique_ptr<server::TTopicMessageSendT>(_e->UnPack(_resolver)); }
  { auto _e = topic_messages_list(); if (_e) _o->topic_messages_list = std::unique_ptr<server::TTopicMessagesListT>(_e->UnPack(_resolver)); }
  { auto _e = topics(); if (_e) _o->topics = std::unique_ptr<server::TTopicsT>(_e->UnPack(_resolver)); }
  { auto _e = topic_message_ack(); if (_e) _o->topic_message_ack = std::unique_ptr<server::TTopicMessageAckT>(_e->UnPack(_resolver)); }
  { auto _e = topic_message(); if (_e) _o->topic_message = std::unique_ptr<server::TopicMessageT>(_e->UnPack(_resolver)); }
  { auto _e = topic_messages(); if (_e) _o->topic_messages = std::unique_ptr<server::TTopicMessagesT>(_e->UnPack(_resolver)); }
  { auto _e = topic_presence(); if (_e) _o->topic_presence = std::unique_ptr<server::TopicPresenceT>(_e->UnPack(_resolver)); }
  { auto _e = match_create(); if (_e) _o->match_create = std::unique_ptr<server::TMatchCreateT>(_e->UnPack(_resolver)); }
  { auto _e = matches_join(); if (_e) _o->matches_join = std::unique_ptr<server::TMatchesJoinT>(_e->UnPack(_resolver)); }
  { auto _e = matches_leave(); if (_e) _o->matches_leave = std::unique_ptr<server::TMatchesLeaveT>(_e->UnPack(_resolver)); }
  { auto _e = match_data_send(); if (_e) _o->match_data_send = std::unique_ptr<server::MatchDataSendT>(_e->UnPack(_resolver)); }
  { auto _e = match(); if (_e) _o->match = std::unique_ptr<server::TMatchT>(_e->UnPack(_resolver)); }
  { auto _e = matches(); if (_e) _o->matches = std::unique_ptr<server::TMatchesT>(_e->UnPack(_resolver)); }
  { auto _e = match_data(); if (_e) _o->match_data = std::unique_ptr<server::MatchDataT>(_e->UnPack(_resolver)); }
  { auto _e = match_presence(); if (_e) _o->match_presence = std::unique_ptr<server::MatchPresenceT>(_e->UnPack(_resolver)); }
  { auto _e = storage_list(); if (_e) _o->storage_list = std::unique_ptr<server::TStorageListT>(_e->UnPack(_resolver)); }
  { auto _e = storage_fetch(); if (_e) _o->storage_fetch = std::unique_ptr<server::TStorageFetchT>(_e->UnPack(_resolver)); }
  { auto _e = storage_write(); if (_e) _o->storage_write = std::unique_ptr<server::TStorageWriteT>(_e->UnPack(_resolver)); }
  { auto _e = storage_update(); if (_e) _o->storage_update = std::unique_ptr<server::TStorageUpdateT>(_e->UnPack(_resolver)); }
  { auto _e = storage_remove(); if (_e) _o->storage_remove = std::unique_ptr<server::TStorageRemoveT>(_e->UnPack(_resolver)); }
  { auto _e = storage_data(); if (_e) _o->storage_data = std::unique_ptr<server::TStorageDataT>(_e->UnPack(_resolver)); }
  { auto _e = storage_keys(); if (_e) _o->storage_keys = std::unique_ptr<server::TStorageKeysT>(_e->UnPack(_resolver)); }
  { auto _e = leaderboards_list(); if (_e) _o->leaderboards_list = std::unique_ptr<server::TLeaderboardsListT>(_e->UnPack(_resolver)); }
  { auto _e = leaderboard_records_write(); if (_e) _o->leaderboard_records_write = std::unique_ptr<server::TLeaderboardRecordsWriteT>(_e->UnPack(_resolver)); }
  { auto _e = leaderboard_records_fetch(); if (_e) _o->leaderboard_records_fetch = std::unique_ptr<server::TLeaderboardRecordsFetchT>(_e->UnPack(_resolver)); }
  { auto _e = leaderboard_records_list(); if (_e) _o->leaderboard_records_list = std::unique_ptr<server::TLeaderboardRecordsListT>(_e->UnPack(_resolver)); }
  { auto _e = leaderboards(); if (_e) _o->leaderboards = std::unique_ptr<server::TLeaderboardsT>(_e->UnPack(_resolver)); }
  { auto _e = leaderboard_records(); if (_e) _o->leaderboard_records = std::unique_ptr<server::TLeaderboardRecordsT>(_e->UnPack(_resolver)); }
  { auto _e = matchmake_add(); if (_e) _o->matchmake_add = std::unique_ptr<server::TMatchmakeAddT>(_e->UnPack(_resolver)); }
  { auto _e = matchmake_remove(); if (_e) _o->matchmake_remove = std::unique_ptr<server::TMatchmakeRemoveT>(_e->UnPack(_resolver)); }
  { auto _e = matchmake_ticket(); if (_e) _o->matchmake_ticket = std::unique_ptr<server::TMatchmakeTicketT>(_e->UnPack(_resolver)); }
  { auto _e = matchmake_matched(); if (_e) _o->matchmake_matched = std::unique_ptr<server::MatchmakeMatchedT>(_e->UnPack(_resolver)); }
  { auto _e = rpc(); if (_e) _o->rpc = std::unique_ptr<server::TRpcT>(_e->UnPack(_resolver)); }
  { auto _e = purchase(); if (_e) _o->purchase = std::unique_ptr<server::TPurchaseValidationT>(_e->UnPack(_resolver)); }
  { auto _e = purchase_record(); if (_e) _o->purchase_record = std::unique_ptr<server::TPurchaseRecordT>(_e->UnPack(_resolver)); }
  { auto _e = notifications_list(); if (_e) _o->notifications_list = std::unique_ptr<server::TNotificationsListT>(_e->UnPack(_resolver)); }
  { auto _e = notifications_remove(); if (_e) _o->notifications_remove = std::unique_ptr<server::TNotificationsRemoveT>(_e->UnPack(_resolver)); }
  { auto _e = notifications(); if (_e) _o->notifications = std::unique_ptr<server::TNotificationsT>(_e->UnPack(_resolver)); }
  { auto _e = live_notifications(); if (_e) _o->live_notifications = std::unique_ptr<server::NotificationsT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<EnvelopeContent> CreateEnvelopeContent(flatbuffers::FlatBufferBuilder &_fbb, const EnvelopeContentT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const EnvelopeContentT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _error = _o->error ? CreateError(_fbb, _o->error.get(), _rehasher) : 0;
...
inline Dictionary EnvelopeContent::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  Dictionary _o ;
  { auto _e = error(); if (_e) _o["error"] = _e->UnPackToDict(_resolver); }
  { auto _e = heartbeat(); if (_e) _o["heartbeat"] = _e->UnPackToDict(_resolver); }
  { auto _e = logout(); if (_e) _o["logout"] = _e->UnPackToDict(_resolver); }
  { auto _e = link(); if (_e) _o["link"] = _e->UnPackToDict(_resolver); }
  { auto _e = unlink(); if (_e) _o["unlink"] = _e->UnPackToDict(_resolver); }
  { auto _e = self_fetch(); if (_e) _o["self_fetch"] = _e->UnPackToDict(_resolver); }
  { auto _e = self_update(); if (_e) _o["self_update"] = _e->UnPackToDict(_resolver); }
  { auto _e = users_fetch(); if (_e) _o["users_fetch"] = _e->UnPackToDict(_resolver); }
  { auto _e = self(); if (_e) _o["self"] = _e->UnPackToDict(_resolver); }
  { auto _e = users(); if (_e) _o["users"] = _e->UnPackToDict(_resolver); }
  { auto _e = friends_add(); if (_e) _o["friends_add"] = _e->UnPackToDict(_resolver); }
  { auto _e = friends_remove(); if (_e) _o["friends_remove"] = _e->UnPackToDict(_resolver); }
  { auto _e = friends_block(); if (_e) _o["friends_block"] = _e->UnPackToDict(_resolver); }
  { auto _e = friends_list(); if (_e) _o["friends_list"] = _e->UnPackToDict(_resolver); }
  { auto _e = friends(); if (_e) _o["friends"] = _e->UnPackToDict(_resolver); }
  { auto _e = groups_create(); if (_e) _o["groups_create"] = _e->UnPackToDict(_resolver); }
  { auto _e = groups_update(); if (_e) _o["groups_update"] = _e->UnPackToDict(_resolver); }
  { auto _e = groups_remove(); if (_e) _o["groups_remove"] = _e->UnPackToDict(_resolver); }
  { auto _e = groups_fetch(); if (_e) _o["groups_fetch"] = _e->UnPackToDict(_resolver); }
  { auto _e = groups_list(); if (_e) _o["groups_list"] = _e->UnPackToDict(_resolver); }
  { auto _e = groups_self_list(); if (_e) _o["groups_self_list"] = _e->UnPackToDict(_resolver); }
  { auto _e = group_users_list(); if (_e) _o["group_users_list"] = _e->UnPackToDict(_resolver); }
  { auto _e = groups_join(); if (_e) _o["groups_join"] = _e->UnPackToDict(_resolver); }
  { auto _e = groups_leave(); if (_e) _o["groups_leave"] = _e->UnPackToDict(_resolver); }
  { auto _e = group_users_add(); if (_e) _o["group_users_add"] = _e->UnPackToDict(_resolver); }
  { auto _e = group_users_kick(); if (_e) _o["group_users_kick"] = _e->UnPackToDict(_resolver); }
  { auto _e = group_users_promote(); if (_e) _o["group_users_promote"] = _e->UnPackToDict(_resolver); }
  { auto _e = groups(); if (_e) _o["groups"] = _e->UnPackToDict(_resolver); }
  { auto _e = groups_self(); if (_e) _o["groups_self"] = _e->UnPackToDict(_resolver); }
  { auto _e = group_users(); if (_e) _o["group_users"] = _e->UnPackToDict(_resolver); }
  { auto _e = topics_join(); if (_e) _o["topics_join"] = _e->UnPackToDict(_resolver); }
  { auto _e = topics_leave(); if (_e) _o["topics_leave"] = _e->UnPackToDict(_resolver); }
  { auto _e = topic_message_send(); if (_e) _o["topic_message_send"] = _e->UnPackToDict(_resolver); }
  { auto _e = topic_messages_list(); if (_e) _o["topic_messages_list"] = _e->UnPackToDict(_resolver); }
  { auto _e = topics(); if (_e) _o["topics"] = _e->UnPackToDict(_resolver); }
  { auto _e = topic_message_ack(); if (_e) _o["topic_message_ack"] = _e->UnPackToDict(_resolver); }
  { auto _e = topic_message(); if (_e) _o["topic_message"] = _e->UnPackToDict(_resolver); }
  { auto _e = topic_messages(); if (_e) _o["topic_messages"] = _e->UnPackToDict(_resolver); }
  { auto _e = topic_presence(); if (_e) _o["topic_presence"] = _e->UnPackToDict(_resolver); }
  { auto _e = match_create(); if (_e) _o["match_create"] = _e->UnPackToDict(_resolver); }
  { auto _e = matches_join(); if (_e) _o["matches_join"] = _e->UnPackToDict(_resolver); }
  { auto _e = matches_leave(); if (_e) _o["matches_leave"] = _e->UnPackToDict(_resolver); }
  { auto _e = match_data_send(); if (_e) _o["match_data_send"] = _e->UnPackToDict(_resolver); }
  { auto _e = match(); if (_e) _o["match"] = _e->UnPackToDict(_resolver); }
  { auto _e = matches(); if (_e) _o["matches"] = _e->UnPackToDict(_resolver); }
  { auto _e = match_data(); if (_e) _o["match_data"] = _e->UnPackToDict(_resolver); }
  { auto _e = match_presence(); if (_e) _o["match_presence"] = _e->UnPackToDict(_resolver); }
  { auto _e = storage_list(); if (_e) _o["storage_list"] = _e->UnPackToDict(_resolver); }
  { auto _e = storage_fetch(); if (_e) _o["storage_fetch"] = _e->UnPackToDict(_resolver); }
  { auto _e = storage_write(); if (_e) _o["storage_write"] = _e->UnPackToDict(_resolver); }
  { auto _e = storage_update(); if (_e) _o["storage_update"] = _e->UnPackToDict(_resolver); }
  { auto _e = storage_remove(); if (_e) _o["storage_remove"] = _e->UnPackToDict(_resolver); }
  { auto _e = storage_data(); if (_e) _o["storage_data"] = _e->UnPackToDict(_resolver); }
  { auto _e = storage_keys(); if (_e) _o["storage_keys"] = _e->UnPackToDict(_resolver); }
  { auto _e = leaderboards_list(); if (_e) _o["leaderboards_list"] = _e->UnPackToDict(_resolver); }
  { auto _e = leaderboard_records_write(); if (_e) _o["leaderboard_records_write"] = _e->UnPackToDict(_resolver); }
  { auto _e = leaderboard_records_fetch(); if (_e) _o["leaderboard_records_fetch"] = _e->UnPackToDict(_resolver); }
  { auto _e = leaderboard_records_list(); if (_e) _o["leaderboard_records_list"] = _e->UnPackToDict(_resolver); }
  { auto _e = leaderboards(); if (_e) _o["leaderboards"] = _e->UnPackToDict(_resolver); }
  { auto _e = leaderboard_records(); if (_e) _o["leaderboard_records"] = _e->UnPackToDict(_resolver); }
  { auto _e = matchmake_add(); if (_e) _o["matchmake_add"] = _e->UnPackToDict(_resolver); }
  { auto _e = matchmake_remove(); if (_e) _o["matchmake_remove"] = _e->UnPackToDict(_resolver); }
  { auto _e = matchmake_ticket(); if (_e) _o["matchmake_ticket"] = _e->UnPackToDict(_resolver); }
  { auto _e = matchmake_matched(); if (_e) _o["matchmake_matched"] = _e->UnPackToDict(_resolver); }
  { auto _e = rpc(); if (_e) _o["rpc"] = _e->UnPackToDict(_resolver); }
  { auto _e = purchase(); if (_e) _o["purchase"] = _e->UnPackToDict(_resolver); }
  { auto _e = purchase_record(); if (_e) _o["purchase_record"] = _e->UnPackToDict(_resolver); }
  { auto _e = notifications_list(); if (_e) _o["notifications_list"] = _e->UnPackToDict(_resolver); }
  { auto _e = notifications_remove(); if (_e) _o["notifications_remove"] = _e->UnPackToDict(_resolver); }
  { auto _e = notifications(); if (_e) _o["notifications"] = _e->UnPackToDict(_resolver); }
  { auto _e = live_notifications(); if (_e) _o["live_notifications"] = _e->UnPackToDict(_resolver); }
  return _o;
}
...
inline flatbuffers::Offset<Logout> CreateLogout(flatbuffers::FlatBufferBuilder &_fbb, const LogoutT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const LogoutT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void TLink::UnPackTo(TLinkT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = std::unique_ptr<server::TLink_::Anonymous3T>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<TLink> CreateTLink(flatbuffers::FlatBufferBuilder &_fbb, const TLinkT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TLinkT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline flatbuffers::Offset<Anonymous3> CreateAnonymous3(flatbuffers::FlatBufferBuilder &_fbb, const Anonymous3T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const Anonymous3T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _email = _o->email ? CreateEmail(_fbb, _o->email.get(), _rehasher) : 0;
  auto _facebook = _o->facebook.empty() ? 0 : _fbb.CreateString(_o->facebook);
  auto _google = _o->google.empty() ? 0 : _fbb.CreateString(_o->google);
  auto _game_center = _o->game_center ? CreateGameCenter(_fbb, _o->game_center.get(), _rehasher) : 0;
...
inline void TUnlink::UnPackTo(TUnlinkT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = std::unique_ptr<server::TUnlink_::Anonymous4T>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<TUnlink> CreateTUnlink(flatbuffers::FlatBufferBuilder &_fbb, const TUnlinkT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TUnlinkT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void Anonymous4::UnPackTo(Anonymous4T *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = facebook(); if (_e) _o->facebook = CharString(_e->c_str(), _e->size()); }
  { auto _e = google(); if (_e) _o->google = CharString(_e->c_str(), _e->size()); }
  { auto _e = game_center(); if (_e) _o->game_center = CharString(_e->c_str(), _e->size()); }
  { auto _e = steam(); if (_e) _o->steam = CharString(_e->c_str(), _e->size()); }
  { auto _e = device(); if (_e) _o->device = CharString(_e->c_str(), _e->size()); }
  { auto _e = custom(); if (_e) _o->custom = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<Anonymous4> CreateAnonymous4(flatbuffers::FlatBufferBuilder &_fbb, const Anonymous4T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const Anonymous4T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _email = _o->email.empty() ? 0 : _fbb.CreateString(_o->email);
  auto _facebook = _o->facebook.empty() ? 0 : _fbb.CreateString(_o->facebook);
  auto _google = _o->google.empty() ? 0 : _fbb.CreateString(_o->google);
...
inline void User::UnPackTo(UserT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = CharString(_e->c_str(), _e->size()); }
  { auto _e = handle(); if (_e) _o->handle = CharString(_e->c_str(), _e->size()); }
  { auto _e = fullname(); if (_e) _o->fullname = CharString(_e->c_str(), _e->size()); }
  { auto _e = avatar_url(); if (_e) _o->avatar_url = CharString(_e->c_str(), _e->size()); }
  { auto _e = lang(); if (_e) _o->lang = CharString(_e->c_str(), _e->size()); }
  { auto _e = location(); if (_e) _o->location = CharString(_e->c_str(), _e->size()); }
  { auto _e = timezone(); if (_e) _o->timezone = CharString(_e->c_str(), _e->size()); }
  { auto _e = metadata(); if (_e) _o->metadata = CharString(_e->c_str(), _e->size()); }
  { auto _e = created_at(); _o->created_at = _e; }
  { auto _e = updated_at(); _o->updated_at = _e; }
  { auto _e = last_online_at(); _o->last_online_at = _e; }
}
...
inline void Self::UnPackTo(SelfT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = user(); if (_e) _o->user = std::unique_ptr<server::UserT>(_e->UnPack(_resolver)); }
  { auto _e = verified(); _o->verified = _e; }
  { auto _e = email(); if (_e) _o->email = CharString(_e->c_str(), _e->size()); }
  { auto _e = device_ids(); if (_e) { _o->device_ids.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->device_ids[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } } }
  { auto _e = facebook_id(); if (_e) _o->facebook_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = google_id(); if (_e) _o->google_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = gamecenter_id(); if (_e) _o->gamecenter_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = steam_id(); if (_e) _o->steam_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = custom_id(); if (_e) _o->custom_id = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<Self> CreateSelf(flatbuffers::FlatBufferBuilder &_fbb, const SelfT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const SelfT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _user = _o->user ? CreateUser(_fbb, _o->user.get(), _rehasher) : 0;
  auto _verified = _o->verified;
  auto _email = _o->email.empty() ? 0 : _fbb.CreateString(_o->email);
  auto _device_ids = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->device_ids.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->device_ids[i]); }, &_va );
...
inline Dictionary Self::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = user(); if (_e) _o["user"] = _e->UnPackToDict(_resolver); }
  { auto _e = verified(); _o["verified"] = _e; }
  { auto _e = email(); if (_e) _o["email"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = device_ids(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } _o["device_ids"] = _a; } }
  { auto _e = facebook_id(); if (_e) _o["facebook_id"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = google_id(); if (_e) _o["google_id"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = gamecenter_id(); if (_e) _o["gamecenter_id"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = steam_id(); if (_e) _o["steam_id"] = CharString(_e->c_str(), _e->size()); }
...
inline flatbuffers::Offset<TSelfFetch> CreateTSelfFetch(flatbuffers::FlatBufferBuilder &_fbb, const TSelfFetchT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TSelfFetchT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void TSelf::UnPackTo(TSelfT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = self(); if (_e) _o->self = std::unique_ptr<server::SelfT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<TSelf> CreateTSelf(flatbuffers::FlatBufferBuilder &_fbb, const TSelfT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TSelfT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline flatbuffers::Offset<TSelfUpdate> CreateTSelfUpdate(flatbuffers::FlatBufferBuilder &_fbb, const TSelfUpdateT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TSelfUpdateT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _handle = _o->handle.empty() ? 0 : _fbb.CreateString(_o->handle);
  auto _fullname = _o->fullname.empty() ? 0 : _fbb.CreateString(_o->fullname);
  auto _timezone = _o->timezone.empty() ? 0 : _fbb.CreateString(_o->timezone);
  auto _location = _o->location.empty() ? 0 : _fbb.CreateString(_o->location);
...
inline void TUsersFetch::UnPackTo(TUsersFetchT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = users(); if (_e) { _o->users.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->users[_i] = std::unique_ptr<server::TUsersFetch_::UsersFetchT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TUsersFetch> CreateTUsersFetch(flatbuffers::FlatBufferBuilder &_fbb, const TUsersFetchT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TUsersFetchT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _users = _fbb.CreateVector<flatbuffers::Offset<server::TUsersFetch_::UsersFetch>> (_o->users.size(), [](size_t i, _VectorArgs *__va) { return CreateUsersFetch(*__va->__fbb, __va->__o->users[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTUsersFetch(
      _fbb,
      _users);
}
...
inline Dictionary TUsersFetch::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = users(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["users"] = _a; } }
  return _o;
}
...
inline void UsersFetch::UnPackTo(UsersFetchT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = std::unique_ptr<server::TUsersFetch_::UsersFetch_::Anonymous5T>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<UsersFetch> CreateUsersFetch(flatbuffers::FlatBufferBuilder &_fbb, const UsersFetchT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const UsersFetchT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void Anonymous5::UnPackTo(Anonymous5T *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = user_id(); if (_e) _o->user_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = handle(); if (_e) _o->handle = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<Anonymous5> CreateAnonymous5(flatbuffers::FlatBufferBuilder &_fbb, const Anonymous5T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const Anonymous5T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void TUsers::UnPackTo(TUsersT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = users(); if (_e) { _o->users.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->users[_i] = std::unique_ptr<server::UserT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TUsers> CreateTUsers(flatbuffers::FlatBufferBuilder &_fbb, const TUsersT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TUsersT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _users = _fbb.CreateVector<flatbuffers::Offset<server::User>> (_o->users.size(), [](size_t i, _VectorArgs *__va) { return CreateUser(*__va->__fbb, __va->__o->users[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTUsers(
      _fbb,
      _users);
}
...
inline flatbuffers::Offset<Friend> CreateFriend(flatbuffers::FlatBufferBuilder &_fbb, const FriendT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const FriendT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _user = _o->user ? CreateUser(_fbb, _o->user.get(), _rehasher) : 0;
...
inline void TFriendsAdd::UnPackTo(TFriendsAddT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = friends(); if (_e) { _o->friends.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->friends[_i] = std::unique_ptr<server::TFriendsAdd_::FriendsAddT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TFriendsAdd> CreateTFriendsAdd(flatbuffers::FlatBufferBuilder &_fbb, const TFriendsAddT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TFriendsAddT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _friends = _fbb.CreateVector<flatbuffers::Offset<server::TFriendsAdd_::FriendsAdd>> (_o->friends.size(), [](size_t i, _VectorArgs *__va) { return CreateFriendsAdd(*__va->__fbb, __va->__o->friends[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTFriendsAdd(
      _fbb,
      _friends);
}
...
inline Dictionary TFriendsAdd::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = friends(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["friends"] = _a; } }
  return _o;
}
...
inline void FriendsAdd::UnPackTo(FriendsAddT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = std::unique_ptr<server::TFriendsAdd_::FriendsAdd_::Anonymous6T>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<FriendsAdd> CreateFriendsAdd(flatbuffers::FlatBufferBuilder &_fbb, const FriendsAddT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const FriendsAddT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline flatbuffers::Offset<Anonymous6> CreateAnonymous6(flatbuffers::FlatBufferBuilder &_fbb, const Anonymous6T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const Anonymous6T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _user_id = _o->user_id.empty() ? 0 : _fbb.CreateString(_o->user_id);
  auto _handle = _o->handle.empty() ? 0 : _fbb.CreateString(_o->handle);
  return server::TFriendsAdd_::FriendsAdd_::CreateAnonymous6(
      _fbb,
...
inline void TFriendsRemove::UnPackTo(TFriendsRemoveT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = user_ids(); if (_e) { _o->user_ids.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->user_ids[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } } }
}
...
inline flatbuffers::Offset<TFriendsRemove> CreateTFriendsRemove(flatbuffers::FlatBufferBuilder &_fbb, const TFriendsRemoveT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TFriendsRemoveT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _user_ids = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->user_ids.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->user_ids[i]); }, &_va );
  return server::CreateTFriendsRemove(
      _fbb,
      _user_ids);
}
...
inline Dictionary TFriendsRemove::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = user_ids(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } _o["user_ids"] = _a; } }
  return _o;
}
...
inline flatbuffers::Offset<TFriendsBlock> CreateTFriendsBlock(flatbuffers::FlatBufferBuilder &_fbb, const TFriendsBlockT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TFriendsBlockT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _user_ids = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->user_ids.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->user_ids[i]); }, &_va );
  return server::CreateTFriendsBlock(
      _fbb,
      _user_ids);
...
inline flatbuffers::Offset<TFriendsList> CreateTFriendsList(flatbuffers::FlatBufferBuilder &_fbb, const TFriendsListT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TFriendsListT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void TFriends::UnPackTo(TFriendsT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = friends(); if (_e) { _o->friends.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->friends[_i] = std::unique_ptr<server::FriendT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TFriends> CreateTFriends(flatbuffers::FlatBufferBuilder &_fbb, const TFriendsT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TFriendsT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _friends = _fbb.CreateVector<flatbuffers::Offset<server::Friend>> (_o->friends.size(), [](size_t i, _VectorArgs *__va) { return CreateFriend(*__va->__fbb, __va->__o->friends[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTFriends(
      _fbb,
      _friends);
}
...
inline void Group::UnPackTo(GroupT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = creator_id(); if (_e) _o->creator_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = name(); if (_e) _o->name = CharString(_e->c_str(), _e->size()); }
  { auto _e = description(); if (_e) _o->description = CharString(_e->c_str(), _e->size()); }
  { auto _e = avatar_url(); if (_e) _o->avatar_url = CharString(_e->c_str(), _e->size()); }
  { auto _e = lang(); if (_e) _o->lang = CharString(_e->c_str(), _e->size()); }
  { auto _e = utc_offset_ms(); _o->utc_offset_ms = _e; }
  { auto _e = metadata(); if (_e) _o->metadata = CharString(_e->c_str(), _e->size()); }
...
inline void TGroupsCreate::UnPackTo(TGroupsCreateT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = groups(); if (_e) { _o->groups.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->groups[_i] = std::unique_ptr<server::TGroupsCreate_::GroupCreateT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TGroupsCreate> CreateTGroupsCreate(flatbuffers::FlatBufferBuilder &_fbb, const TGroupsCreateT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupsCreateT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _groups = _fbb.CreateVector<flatbuffers::Offset<server::TGroupsCreate_::GroupCreate>> (_o->groups.size(), [](size_t i, _VectorArgs *__va) { return CreateGroupCreate(*__va->__fbb, __va->__o->groups[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTGroupsCreate(
      _fbb,
      _groups);
}
...
inline Dictionary TGroupsCreate::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = groups(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["groups"] = _a; } }
  return _o;
}
...
inline flatbuffers::Offset<GroupCreate> CreateGroupCreate(flatbuffers::FlatBufferBuilder &_fbb, const GroupCreateT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const GroupCreateT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _name = _o->name.empty() ? 0 : _fbb.CreateString(_o->name);
  auto _description = _o->description.empty() ? 0 : _fbb.CreateString(_o->description);
  auto _avatar_url = _o->avatar_url.empty() ? 0 : _fbb.CreateString(_o->avatar_url);
  auto _lang = _o->lang.empty() ? 0 : _fbb.CreateString(_o->lang);
...
inline void TGroupsUpdate::UnPackTo(TGroupsUpdateT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = groups(); if (_e) { _o->groups.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->groups[_i] = std::unique_ptr<server::TGroupsUpdate_::GroupUpdateT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TGroupsUpdate> CreateTGroupsUpdate(flatbuffers::FlatBufferBuilder &_fbb, const TGroupsUpdateT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupsUpdateT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _groups = _fbb.CreateVector<flatbuffers::Offset<server::TGroupsUpdate_::GroupUpdate>> (_o->groups.size(), [](size_t i, _VectorArgs *__va) { return CreateGroupUpdate(*__va->__fbb, __va->__o->groups[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTGroupsUpdate(
      _fbb,
      _groups);
}
...
inline void GroupUpdate::UnPackTo(GroupUpdateT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = group_id(); if (_e) _o->group_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = private_(); _o->private_ = _e; }
  { auto _e = name(); if (_e) _o->name = CharString(_e->c_str(), _e->size()); }
  { auto _e = description(); if (_e) _o->description = CharString(_e->c_str(), _e->size()); }
  { auto _e = avatar_url(); if (_e) _o->avatar_url = CharString(_e->c_str(), _e->size()); }
...
inline flatbuffers::Offset<GroupUpdate> CreateGroupUpdate(flatbuffers::FlatBufferBuilder &_fbb, const GroupUpdateT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const GroupUpdateT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void TGroupsRemove::UnPackTo(TGroupsRemoveT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = group_ids(); if (_e) { _o->group_ids.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->group_ids[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } } }
}
...
inline flatbuffers::Offset<TGroupsRemove> CreateTGroupsRemove(flatbuffers::FlatBufferBuilder &_fbb, const TGroupsRemoveT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupsRemoveT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _group_ids = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->group_ids.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->group_ids[i]); }, &_va );
  return server::CreateTGroupsRemove(
      _fbb,
      _group_ids);
}
...
inline Dictionary TGroupsRemove::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = group_ids(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } _o["group_ids"] = _a; } }
  return _o;
}
...
inline flatbuffers::Offset<TGroupsSelfList> CreateTGroupsSelfList(flatbuffers::FlatBufferBuilder &_fbb, const TGroupsSelfListT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupsSelfListT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void TGroupsFetch::UnPackTo(TGroupsFetchT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = groups(); if (_e) { _o->groups.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->groups[_i] = std::unique_ptr<server::TGroupsFetch_::GroupFetchT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TGroupsFetch> CreateTGroupsFetch(flatbuffers::FlatBufferBuilder &_fbb, const TGroupsFetchT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupsFetchT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _groups = _fbb.CreateVector<flatbuffers::Offset<server::TGroupsFetch_::GroupFetch>> (_o->groups.size(), [](size_t i, _VectorArgs *__va) { return CreateGroupFetch(*__va->__fbb, __va->__o->groups[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTGroupsFetch(
      _fbb,
      _groups);
}
...
inline void GroupFetch::UnPackTo(GroupFetchT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = std::unique_ptr<server::TGroupsFetch_::GroupFetch_::Anonymous7T>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<GroupFetch> CreateGroupFetch(flatbuffers::FlatBufferBuilder &_fbb, const GroupFetchT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const GroupFetchT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline flatbuffers::Offset<Anonymous7> CreateAnonymous7(flatbuffers::FlatBufferBuilder &_fbb, const Anonymous7T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const Anonymous7T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _group_id = _o->group_id.empty() ? 0 : _fbb.CreateString(_o->group_id);
  auto _name = _o->name.empty() ? 0 : _fbb.CreateString(_o->name);
  return server::TGroupsFetch_::GroupFetch_::CreateAnonymous7(
      _fbb,
...
inline void TGroupsList::UnPackTo(TGroupsListT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = page_limit(); _o->page_limit = _e; }
  { auto _e = order_by_asc(); _o->order_by_asc = _e; }
  { auto _e = filter(); if (_e) _o->filter = std::unique_ptr<server::TGroupsList_::Anonymous8T>(_e->UnPack(_resolver)); }
  { auto _e = cursor(); if (_e) _o->cursor = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TGroupsList> CreateTGroupsList(flatbuffers::FlatBufferBuilder &_fbb, const TGroupsListT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupsListT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline Dictionary TGroupsList::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = page_limit(); _o["page_limit"] = _e; }
  { auto _e = order_by_asc(); _o["order_by_asc"] = _e; }
  { auto _e = filter(); if (_e) _o["filter"] = _e->UnPackToDict(_resolver); }
  { auto _e = cursor(); if (_e) _o["cursor"] = CharString(_e->c_str(), _e->size()); }
  return _o;
}
...
inline flatbuffers::Offset<Anonymous8> CreateAnonymous8(flatbuffers::FlatBufferBuilder &_fbb, const Anonymous8T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const Anonymous8T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _lang = _o->lang.empty() ? 0 : _fbb.CreateString(_o->lang);
  auto _created_at = _o->created_at;
  auto _count = _o->count;
  return server::TGroupsList_::CreateAnonymous8(
...
inline void TGroups::UnPackTo(TGroupsT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = groups(); if (_e) { _o->groups.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->groups[_i] = std::unique_ptr<server::GroupT>(_e->Get(_i)->UnPack(_resolver)); } } }
  { auto _e = cursor(); if (_e) _o->cursor = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TGroups> CreateTGroups(flatbuffers::FlatBufferBuilder &_fbb, const TGroupsT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupsT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _groups = _fbb.CreateVector<flatbuffers::Offset<server::Group>> (_o->groups.size(), [](size_t i, _VectorArgs *__va) { return CreateGroup(*__va->__fbb, __va->__o->groups[i].get(), __va->__rehasher); }, &_va );
  auto _cursor = _o->cursor.empty() ? 0 : _fbb.CreateString(_o->cursor);
  return server::CreateTGroups(
      _fbb,
      _groups,
...
inline void TGroupsSelf::UnPackTo(TGroupsSelfT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = groups_self(); if (_e) { _o->groups_self.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->groups_self[_i] = std::unique_ptr<server::TGroupsSelf_::GroupSelfT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TGroupsSelf> CreateTGroupsSelf(flatbuffers::FlatBufferBuilder &_fbb, const TGroupsSelfT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupsSelfT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _groups_self = _fbb.CreateVector<flatbuffers::Offset<server::TGroupsSelf_::GroupSelf>> (_o->groups_self.size(), [](size_t i, _VectorArgs *__va) { return CreateGroupSelf(*__va->__fbb, __va->__o->groups_self[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTGroupsSelf(
      _fbb,
      _groups_self);
}
...
inline Dictionary TGroupsSelf::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = groups_self(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["groups_self"] = _a; } }
  return _o;
}
...
inline void GroupSelf::UnPackTo(GroupSelfT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = group(); if (_e) _o->group = std::unique_ptr<server::GroupT>(_e->UnPack(_resolver)); }
  { auto _e = state(); _o->state = _e; }
}
...
inline flatbuffers::Offset<GroupSelf> CreateGroupSelf(flatbuffers::FlatBufferBuilder &_fbb, const GroupSelfT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const GroupSelfT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline Dictionary GroupSelf::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = group(); if (_e) _o["group"] = _e->UnPackToDict(_resolver); }
  { auto _e = state(); _o["state"] = _e; }
  return _o;
}
...
inline flatbuffers::Offset<GroupUser> CreateGroupUser(flatbuffers::FlatBufferBuilder &_fbb, const GroupUserT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const GroupUserT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _user = _o->user ? CreateUser(_fbb, _o->user.get(), _rehasher) : 0;
  auto _state = _o->state;
...
inline flatbuffers::Offset<TGroupUsersList> CreateTGroupUsersList(flatbuffers::FlatBufferBuilder &_fbb, const TGroupUsersListT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupUsersListT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _group_id = _o->group_id.empty() ? 0 : _fbb.CreateString(_o->group_id);
  return server::CreateTGroupUsersList(
      _fbb,
      _group_id);
...
inline void TGroupUsers::UnPackTo(TGroupUsersT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = users(); if (_e) { _o->users.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->users[_i] = std::unique_ptr<server::GroupUserT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TGroupUsers> CreateTGroupUsers(flatbuffers::FlatBufferBuilder &_fbb, const TGroupUsersT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupUsersT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _users = _fbb.CreateVector<flatbuffers::Offset<server::GroupUser>> (_o->users.size(), [](size_t i, _VectorArgs *__va) { return CreateGroupUser(*__va->__fbb, __va->__o->users[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTGroupUsers(
      _fbb,
      _users);
}
...
inline flatbuffers::Offset<TGroupsJoin> CreateTGroupsJoin(flatbuffers::FlatBufferBuilder &_fbb, const TGroupsJoinT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupsJoinT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _group_ids = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->group_ids.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->group_ids[i]); }, &_va );
  return server::CreateTGroupsJoin(
      _fbb,
      _group_ids);
...
inline flatbuffers::Offset<TGroupsLeave> CreateTGroupsLeave(flatbuffers::FlatBufferBuilder &_fbb, const TGroupsLeaveT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupsLeaveT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _group_ids = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->group_ids.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->group_ids[i]); }, &_va );
  return server::CreateTGroupsLeave(
      _fbb,
      _group_ids);
...
inline void TGroupUsersAdd::UnPackTo(TGroupUsersAddT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = group_users(); if (_e) { _o->group_users.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->group_users[_i] = std::unique_ptr<server::TGroupUsersAdd_::GroupUserAddT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TGroupUsersAdd> CreateTGroupUsersAdd(flatbuffers::FlatBufferBuilder &_fbb, const TGroupUsersAddT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupUsersAddT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _group_users = _fbb.CreateVector<flatbuffers::Offset<server::TGroupUsersAdd_::GroupUserAdd>> (_o->group_users.size(), [](size_t i, _VectorArgs *__va) { return CreateGroupUserAdd(*__va->__fbb, __va->__o->group_users[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTGroupUsersAdd(
      _fbb,
      _group_users);
}
...
inline Dictionary TGroupUsersAdd::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = group_users(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["group_users"] = _a; } }
  return _o;
}
...
inline flatbuffers::Offset<GroupUserAdd> CreateGroupUserAdd(flatbuffers::FlatBufferBuilder &_fbb, const GroupUserAddT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const GroupUserAddT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _group_id = _o->group_id.empty() ? 0 : _fbb.CreateString(_o->group_id);
  auto _user_id = _o->user_id.empty() ? 0 : _fbb.CreateString(_o->user_id);
  return server::TGroupUsersAdd_::CreateGroupUserAdd(
      _fbb,
...
inline void TGroupUsersKick::UnPackTo(TGroupUsersKickT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = group_users(); if (_e) { _o->group_users.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->group_users[_i] = std::unique_ptr<server::TGroupUsersKick_::GroupUserKickT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TGroupUsersKick> CreateTGroupUsersKick(flatbuffers::FlatBufferBuilder &_fbb, const TGroupUsersKickT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupUsersKickT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _group_users = _fbb.CreateVector<flatbuffers::Offset<server::TGroupUsersKick_::GroupUserKick>> (_o->group_users.size(), [](size_t i, _VectorArgs *__va) { return CreateGroupUserKick(*__va->__fbb, __va->__o->group_users[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTGroupUsersKick(
      _fbb,
      _group_users);
}
...
inline flatbuffers::Offset<GroupUserKick> CreateGroupUserKick(flatbuffers::FlatBufferBuilder &_fbb, const GroupUserKickT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const GroupUserKickT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _group_id = _o->group_id.empty() ? 0 : _fbb.CreateString(_o->group_id);
  auto _user_id = _o->user_id.empty() ? 0 : _fbb.CreateString(_o->user_id);
  return server::TGroupUsersKick_::CreateGroupUserKick(
      _fbb,
...
inline void TGroupUsersPromote::UnPackTo(TGroupUsersPromoteT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = group_users(); if (_e) { _o->group_users.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->group_users[_i] = std::unique_ptr<server::TGroupUsersPromote_::GroupUserPromoteT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TGroupUsersPromote> CreateTGroupUsersPromote(flatbuffers::FlatBufferBuilder &_fbb, const TGroupUsersPromoteT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TGroupUsersPromoteT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _group_users = _fbb.CreateVector<flatbuffers::Offset<server::TGroupUsersPromote_::GroupUserPromote>> (_o->group_users.size(), [](size_t i, _VectorArgs *__va) { return CreateGroupUserPromote(*__va->__fbb, __va->__o->group_users[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTGroupUsersPromote(
      _fbb,
      _group_users);
}
...
inline flatbuffers::Offset<GroupUserPromote> CreateGroupUserPromote(flatbuffers::FlatBufferBuilder &_fbb, const GroupUserPromoteT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const GroupUserPromoteT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _group_id = _o->group_id.empty() ? 0 : _fbb.CreateString(_o->group_id);
  auto _user_id = _o->user_id.empty() ? 0 : _fbb.CreateString(_o->user_id);
  return server::TGroupUsersPromote_::CreateGroupUserPromote(
      _fbb,
...
inline void TopicId::UnPackTo(TopicIdT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = std::unique_ptr<server::TopicId_::TopicTypeT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<TopicId> CreateTopicId(flatbuffers::FlatBufferBuilder &_fbb, const TopicIdT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TopicIdT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void TopicType::UnPackTo(TopicTypeT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = dm(); if (_e) _o->dm = CharString(_e->c_str(), _e->size()); }
  { auto _e = room(); if (_e) _o->room = CharString(_e->c_str(), _e->size()); }
  { auto _e = group_id(); if (_e) _o->group_id = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TopicType> CreateTopicType(flatbuffers::FlatBufferBuilder &_fbb, const TopicTypeT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TopicTypeT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void UserPresence::UnPackTo(UserPresenceT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = user_id(); if (_e) _o->user_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = session_id(); if (_e) _o->session_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = handle(); if (_e) _o->handle = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<UserPresence> CreateUserPresence(flatbuffers::FlatBufferBuilder &_fbb, const UserPresenceT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const UserPresenceT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _user_id = _o->user_id.empty() ? 0 : _fbb.CreateString(_o->user_id);
...
inline void TTopicsJoin::UnPackTo(TTopicsJoinT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = joins(); if (_e) { _o->joins.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->joins[_i] = std::unique_ptr<server::TTopicsJoin_::TopicJoinT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TTopicsJoin> CreateTTopicsJoin(flatbuffers::FlatBufferBuilder &_fbb, const TTopicsJoinT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TTopicsJoinT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _joins = _fbb.CreateVector<flatbuffers::Offset<server::TTopicsJoin_::TopicJoin>> (_o->joins.size(), [](size_t i, _VectorArgs *__va) { return CreateTopicJoin(*__va->__fbb, __va->__o->joins[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTTopicsJoin(
      _fbb,
      _joins);
}
...
inline Dictionary TTopicsJoin::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = joins(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["joins"] = _a; } }
  return _o;
}
...
inline void TopicJoin::UnPackTo(TopicJoinT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = std::unique_ptr<server::TTopicsJoin_::TopicJoin_::AuthenticateResult0T>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<TopicJoin> CreateTopicJoin(flatbuffers::FlatBufferBuilder &_fbb, const TopicJoinT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TopicJoinT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline flatbuffers::Offset<AuthenticateResult0> CreateAuthenticateResult0(flatbuffers::FlatBufferBuilder &_fbb, const AuthenticateResult0T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const AuthenticateResult0T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _user_id = _o->user_id.empty() ? 0 : _fbb.CreateString(_o->user_id);
  auto _room = _o->room.empty() ? 0 : _fbb.CreateString(_o->room);
  auto _group_id = _o->group_id.empty() ? 0 : _fbb.CreateString(_o->group_id);
  return server::TTopicsJoin_::TopicJoin_::CreateAuthenticateResult0(
...
inline void TTopics::UnPackTo(TTopicsT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = topics(); if (_e) { _o->topics.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->topics[_i] = std::unique_ptr<server::TTopics_::TopicT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TTopics> CreateTTopics(flatbuffers::FlatBufferBuilder &_fbb, const TTopicsT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TTopicsT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _topics = _fbb.CreateVector<flatbuffers::Offset<server::TTopics_::Topic>> (_o->topics.size(), [](size_t i, _VectorArgs *__va) { return CreateTopic(*__va->__fbb, __va->__o->topics[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTTopics(
      _fbb,
      _topics);
}
...
inline Dictionary TTopics::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = topics(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["topics"] = _a; } }
  return _o;
}
...
inline void Topic::UnPackTo(TopicT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = topic(); if (_e) _o->topic = std::unique_ptr<server::TopicIdT>(_e->UnPack(_resolver)); }
  { auto _e = presences(); if (_e) { _o->presences.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->presences[_i] = std::unique_ptr<server::UserPresenceT>(_e->Get(_i)->UnPack(_resolver)); } } }
  { auto _e = self(); if (_e) _o->self = std::unique_ptr<server::UserPresenceT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<Topic> CreateTopic(flatbuffers::FlatBufferBuilder &_fbb, const TopicT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TopicT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _topic = _o->topic ? CreateTopicId(_fbb, _o->topic.get(), _rehasher) : 0;
  auto _presences = _fbb.CreateVector<flatbuffers::Offset<server::UserPresence>> (_o->presences.size(), [](size_t i, _VectorArgs *__va) { return CreateUserPresence(*__va->__fbb, __va->__o->presences[i].get(), __va->__rehasher); }, &_va );
...
inline Dictionary Topic::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = topic(); if (_e) _o["topic"] = _e->UnPackToDict(_resolver); }
  { auto _e = presences(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["presences"] = _a; } }
  { auto _e = self(); if (_e) _o["self"] = _e->UnPackToDict(_resolver); }
  return _o;
}
...
inline void TTopicsLeave::UnPackTo(TTopicsLeaveT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = topics(); if (_e) { _o->topics.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->topics[_i] = std::unique_ptr<server::TopicIdT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TTopicsLeave> CreateTTopicsLeave(flatbuffers::FlatBufferBuilder &_fbb, const TTopicsLeaveT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TTopicsLeaveT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _topics = _fbb.CreateVector<flatbuffers::Offset<server::TopicId>> (_o->topics.size(), [](size_t i, _VectorArgs *__va) { return CreateTopicId(*__va->__fbb, __va->__o->topics[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTTopicsLeave(
      _fbb,
      _topics);
}
...
inline void TTopicMessageSend::UnPackTo(TTopicMessageSendT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = topic(); if (_e) _o->topic = std::unique_ptr<server::TopicIdT>(_e->UnPack(_resolver)); }
  { auto _e = data(); if (_e) _o->data = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TTopicMessageSend> CreateTTopicMessageSend(flatbuffers::FlatBufferBuilder &_fbb, const TTopicMessageSendT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TTopicMessageSendT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _topic = _o->topic ? CreateTopicId(_fbb, _o->topic.get(), _rehasher) : 0;
...
inline void TTopicMessageAck::UnPackTo(TTopicMessageAckT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = message_id(); if (_e) _o->message_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = created_at(); _o->created_at = _e; }
...
inline flatbuffers::Offset<TTopicMessageAck> CreateTTopicMessageAck(flatbuffers::FlatBufferBuilder &_fbb, const TTopicMessageAckT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TTopicMessageAckT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline flatbuffers::Offset<TopicMessage> CreateTopicMessage(flatbuffers::FlatBufferBuilder &_fbb, const TopicMessageT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TopicMessageT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _topic = _o->topic ? CreateTopicId(_fbb, _o->topic.get(), _rehasher) : 0;
  auto _user_id = _o->user_id.empty() ? 0 : _fbb.CreateString(_o->user_id);
  auto _message_id = _o->message_id.empty() ? 0 : _fbb.CreateString(_o->message_id);
  auto _created_at = _o->created_at;
...
inline void TTopicMessagesList::UnPackTo(TTopicMessagesListT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = std::unique_ptr<server::TTopicMessagesList_::AuthenticateResult1T>(_e->UnPack(_resolver)); }
  { auto _e = cursor(); if (_e) _o->cursor = CharString(_e->c_str(), _e->size()); }
...
inline flatbuffers::Offset<TTopicMessagesList> CreateTTopicMessagesList(flatbuffers::FlatBufferBuilder &_fbb, const TTopicMessagesListT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TTopicMessagesListT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline flatbuffers::Offset<AuthenticateResult1> CreateAuthenticateResult1(flatbuffers::FlatBufferBuilder &_fbb, const AuthenticateResult1T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const AuthenticateResult1T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _user_id = _o->user_id.empty() ? 0 : _fbb.CreateString(_o->user_id);
  auto _room = _o->room.empty() ? 0 : _fbb.CreateString(_o->room);
  auto _group_id = _o->group_id.empty() ? 0 : _fbb.CreateString(_o->group_id);
  return server::TTopicMessagesList_::CreateAuthenticateResult1(
...
inline void TTopicMessages::UnPackTo(TTopicMessagesT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = messages(); if (_e) { _o->messages.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->messages[_i] = std::unique_ptr<server::TopicMessageT>(_e->Get(_i)->UnPack(_resolver)); } } }
  { auto _e = cursor(); if (_e) _o->cursor = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TTopicMessages> CreateTTopicMessages(flatbuffers::FlatBufferBuilder &_fbb, const TTopicMessagesT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TTopicMessagesT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _messages = _fbb.CreateVector<flatbuffers::Offset<server::TopicMessage>> (_o->messages.size(), [](size_t i, _VectorArgs *__va) { return CreateTopicMessage(*__va->__fbb, __va->__o->messages[i].get(), __va->__rehasher); }, &_va );
  auto _cursor = _o->cursor.empty() ? 0 : _fbb.CreateString(_o->cursor);
  return server::CreateTTopicMessages(
      _fbb,
      _messages,
...
inline Dictionary TTopicMessages::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = messages(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["messages"] = _a; } }
  { auto _e = cursor(); if (_e) _o["cursor"] = CharString(_e->c_str(), _e->size()); }
  return _o;
}
...
inline void TopicPresence::UnPackTo(TopicPresenceT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = topic(); if (_e) _o->topic = std::unique_ptr<server::TopicIdT>(_e->UnPack(_resolver)); }
  { auto _e = joins(); if (_e) { _o->joins.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->joins[_i] = std::unique_ptr<server::UserPresenceT>(_e->Get(_i)->UnPack(_resolver)); } } }
  { auto _e = leaves(); if (_e) { _o->leaves.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->leaves[_i] = std::unique_ptr<server::UserPresenceT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TopicPresence> CreateTopicPresence(flatbuffers::FlatBufferBuilder &_fbb, const TopicPresenceT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TopicPresenceT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _topic = _o->topic ? CreateTopicId(_fbb, _o->topic.get(), _rehasher) : 0;
  auto _joins = _fbb.CreateVector<flatbuffers::Offset<server::UserPresence>> (_o->joins.size(), [](size_t i, _VectorArgs *__va) { return CreateUserPresence(*__va->__fbb, __va->__o->joins[i].get(), __va->__rehasher); }, &_va );
  auto _leaves = _fbb.CreateVector<flatbuffers::Offset<server::UserPresence>> (_o->leaves.size(), [](size_t i, _VectorArgs *__va) { return CreateUserPresence(*__va->__fbb, __va->__o->leaves[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTopicPresence(
      _fbb,
      _topic,
      _joins,
...
inline Dictionary TopicPresence::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = topic(); if (_e) _o["topic"] = _e->UnPackToDict(_resolver); }
  { auto _e = joins(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["joins"] = _a; } }
  { auto _e = leaves(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["leaves"] = _a; } }
  return _o;
}
...
inline void PropertyPair::UnPackTo(PropertyPairT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = key(); if (_e) _o->key = CharString(_e->c_str(), _e->size()); }
  { auto _e = value(); if (_e) _o->value = std::unique_ptr<server::PropertyPair_::AuthenticateResult2T>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<PropertyPair> CreatePropertyPair(flatbuffers::FlatBufferBuilder &_fbb, const PropertyPairT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const PropertyPairT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline Dictionary PropertyPair::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  Dictionary _o ;
  { auto _e = key(); if (_e) _o["key"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = value(); if (_e) _o["value"] = _e->UnPackToDict(_resolver); }
  return _o;
}
...
inline void StringSet::UnPackTo(StringSetT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = values(); if (_e) { _o->values.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->values[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } } }
}
...
inline flatbuffers::Offset<StringSet> CreateStringSet(flatbuffers::FlatBufferBuilder &_fbb, const StringSetT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const StringSetT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _values = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->values.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->values[i]); }, &_va );
  return server::PropertyPair_::CreateStringSet(
      _fbb,
      _values);
}
...
inline Dictionary StringSet::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = values(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } _o["values"] = _a; } }
  return _o;
}
...
inline void AuthenticateResult2::UnPackTo(AuthenticateResult2T *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = string_set(); if (_e) _o->string_set = std::unique_ptr<server::PropertyPair_::StringSetT>(_e->UnPack(_resolver)); }
...
inline flatbuffers::Offset<AuthenticateResult2> CreateAuthenticateResult2(flatbuffers::FlatBufferBuilder &_fbb, const AuthenticateResult2T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const AuthenticateResult2T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline Dictionary AuthenticateResult2::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = string_set(); if (_e) _o["string_set"] = _e->UnPackToDict(_resolver); }
  { auto _e = bool_value(); _o["bool_value"] = _e; }
  { auto _e = int_value(); _o["int_value"] = _e; }
  return _o;
}
...
inline void MatchmakeFilter::UnPackTo(MatchmakeFilterT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = name(); if (_e) _o->name = CharString(_e->c_str(), _e->size()); }
  { auto _e = value(); if (_e) _o->value = std::unique_ptr<server::MatchmakeFilter_::AuthenticateResult3T>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<MatchmakeFilter> CreateMatchmakeFilter(flatbuffers::FlatBufferBuilder &_fbb, const MatchmakeFilterT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const MatchmakeFilterT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _name = _o->name.empty() ? 0 : _fbb.CreateString(_o->name);
...
inline void TermFilter::UnPackTo(TermFilterT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = terms(); if (_e) { _o->terms.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->terms[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } } }
  { auto _e = match_all_terms(); _o->match_all_terms = _e; }
}
...
inline flatbuffers::Offset<TermFilter> CreateTermFilter(flatbuffers::FlatBufferBuilder &_fbb, const TermFilterT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TermFilterT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _terms = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->terms.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->terms[i]); }, &_va );
...
inline Dictionary TermFilter::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = terms(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } _o["terms"] = _a; } }
  { auto _e = match_all_terms(); _o["match_all_terms"] = _e; }
  return _o;
}
...
inline void RangeFilter::UnPackTo(RangeFilterT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = lower_bound(); _o->lower_bound = _e; }
  { auto _e = upper_bound(); _o->upper_bound = _e; }
}
...
inline flatbuffers::Offset<RangeFilter> CreateRangeFilter(flatbuffers::FlatBufferBuilder &_fbb, const RangeFilterT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const RangeFilterT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void AuthenticateResult3::UnPackTo(AuthenticateResult3T *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = term(); if (_e) _o->term = std::unique_ptr<server::MatchmakeFilter_::TermFilterT>(_e->UnPack(_resolver)); }
  { auto _e = range(); if (_e) _o->range = std::unique_ptr<server::MatchmakeFilter_::RangeFilterT>(_e->UnPack(_resolver)); }
  { auto _e = check(); _o->check = _e; }
}
...
inline flatbuffers::Offset<AuthenticateResult3> CreateAuthenticateResult3(flatbuffers::FlatBufferBuilder &_fbb, const AuthenticateResult3T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const AuthenticateResult3T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline Dictionary AuthenticateResult3::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = term(); if (_e) _o["term"] = _e->UnPackToDict(_resolver); }
  { auto _e = range(); if (_e) _o["range"] = _e->UnPackToDict(_resolver); }
  { auto _e = check(); _o["check"] = _e; }
  return _o;
}
...
inline void TMatchmakeAdd::UnPackTo(TMatchmakeAddT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = required_count(); _o->required_count = _e; }
  { auto _e = filters(); if (_e) { _o->filters.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->filters[_i] = std::unique_ptr<server::MatchmakeFilterT>(_e->Get(_i)->UnPack(_resolver)); } } }
  { auto _e = properties(); if (_e) { _o->properties.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->properties[_i] = std::unique_ptr<server::PropertyPairT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TMatchmakeAdd> CreateTMatchmakeAdd(flatbuffers::FlatBufferBuilder &_fbb, const TMatchmakeAddT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TMatchmakeAddT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _required_count = _o->required_count;
  auto _filters = _fbb.CreateVector<flatbuffers::Offset<server::MatchmakeFilter>> (_o->filters.size(), [](size_t i, _VectorArgs *__va) { return CreateMatchmakeFilter(*__va->__fbb, __va->__o->filters[i].get(), __va->__rehasher); }, &_va );
  auto _properties = _fbb.CreateVector<flatbuffers::Offset<server::PropertyPair>> (_o->properties.size(), [](size_t i, _VectorArgs *__va) { return CreatePropertyPair(*__va->__fbb, __va->__o->properties[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTMatchmakeAdd(
      _fbb,
      _required_count,
      _filters,
...
inline Dictionary TMatchmakeAdd::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  Dictionary _o ;
  { auto _e = required_count(); _o["required_count"] = _e; }
  { auto _e = filters(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["filters"] = _a; } }
  { auto _e = properties(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["properties"] = _a; } }
  return _o;
}
...
inline void TMatchmakeTicket::UnPackTo(TMatchmakeTicketT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = ticket(); if (_e) _o->ticket = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TMatchmakeTicket> CreateTMatchmakeTicket(flatbuffers::FlatBufferBuilder &_fbb, const TMatchmakeTicketT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TMatchmakeTicketT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline flatbuffers::Offset<TMatchmakeRemove> CreateTMatchmakeRemove(flatbuffers::FlatBufferBuilder &_fbb, const TMatchmakeRemoveT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TMatchmakeRemoveT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _ticket = _o->ticket.empty() ? 0 : _fbb.CreateString(_o->ticket);
  return server::CreateTMatchmakeRemove(
      _fbb,
      _ticket);
...
inline void MatchmakeMatched::UnPackTo(MatchmakeMatchedT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = presences(); if (_e) { _o->presences.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->presences[_i] = std::unique_ptr<server::UserPresenceT>(_e->Get(_i)->UnPack(_resolver)); } } }
  { auto _e = self(); if (_e) _o->self = std::unique_ptr<server::UserPresenceT>(_e->UnPack(_resolver)); }
  { auto _e = properties(); if (_e) { _o->properties.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->properties[_i] = std::unique_ptr<server::MatchmakeMatched_::UserPropertyT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<MatchmakeMatched> CreateMatchmakeMatched(flatbuffers::FlatBufferBuilder &_fbb, const MatchmakeMatchedT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const MatchmakeMatchedT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _ticket = _o->ticket.empty() ? 0 : _fbb.CreateString(_o->ticket);
  auto _token = _o->token.empty() ? 0 : _fbb.CreateString(_o->token);
  auto _presences = _fbb.CreateVector<flatbuffers::Offset<server::UserPresence>> (_o->presences.size(), [](size_t i, _VectorArgs *__va) { return CreateUserPresence(*__va->__fbb, __va->__o->presences[i].get(), __va->__rehasher); }, &_va );
  auto _self = _o->self ? CreateUserPresence(_fbb, _o->self.get(), _rehasher) : 0;
  auto _properties = _fbb.CreateVector<flatbuffers::Offset<server::MatchmakeMatched_::UserProperty>> (_o->properties.size(), [](size_t i, _VectorArgs *__va) { return CreateUserProperty(*__va->__fbb, __va->__o->properties[i].get(), __va->__rehasher); }, &_va );
  return server::CreateMatchmakeMatched(
      _fbb,
      _ticket,
      _token,
...
inline flatbuffers::Offset<UserProperty> CreateUserProperty(flatbuffers::FlatBufferBuilder &_fbb, const UserPropertyT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const UserPropertyT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _user_id = _o->user_id.empty() ? 0 : _fbb.CreateString(_o->user_id);
  auto _properties = _fbb.CreateVector<flatbuffers::Offset<server::PropertyPair>> (_o->properties.size(), [](size_t i, _VectorArgs *__va) { return CreatePropertyPair(*__va->__fbb, __va->__o->properties[i].get(), __va->__rehasher); }, &_va );
  auto _filters = _fbb.CreateVector<flatbuffers::Offset<server::MatchmakeFilter>> (_o->filters.size(), [](size_t i, _VectorArgs *__va) { return CreateMatchmakeFilter(*__va->__fbb, __va->__o->filters[i].get(), __va->__rehasher); }, &_va );
  return server::MatchmakeMatched_::CreateUserProperty(
...
inline void Match::UnPackTo(MatchT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = match_id(); if (_e) _o->match_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = presences(); if (_e) { _o->presences.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->presences[_i] = std::unique_ptr<server::UserPresenceT>(_e->Get(_i)->UnPack(_resolver)); } } }
  { auto _e = self(); if (_e) _o->self = std::unique_ptr<server::UserPresenceT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<MatchPresence> CreateMatchPresence(flatbuffers::FlatBufferBuilder &_fbb, const MatchPresenceT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const MatchPresenceT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _match_id = _o->match_id.empty() ? 0 : _fbb.CreateString(_o->match_id);
  auto _joins = _fbb.CreateVector<flatbuffers::Offset<server::UserPresence>> (_o->joins.size(), [](size_t i, _VectorArgs *__va) { return CreateUserPresence(*__va->__fbb, __va->__o->joins[i].get(), __va->__rehasher); }, &_va );
  auto _leaves = _fbb.CreateVector<flatbuffers::Offset<server::UserPresence>> (_o->leaves.size(), [](size_t i, _VectorArgs *__va) { return CreateUserPresence(*__va->__fbb, __va->__o->leaves[i].get(), __va->__rehasher); }, &_va );
  return server::CreateMatchPresence(
...
inline flatbuffers::Offset<TMatchCreate> CreateTMatchCreate(flatbuffers::FlatBufferBuilder &_fbb, const TMatchCreateT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TMatchCreateT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void TMatch::UnPackTo(TMatchT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = match(); if (_e) _o->match = std::unique_ptr<server::MatchT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<TMatch> CreateTMatch(flatbuffers::FlatBufferBuilder &_fbb, const TMatchT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TMatchT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void TMatchesJoin::UnPackTo(TMatchesJoinT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = matches(); if (_e) { _o->matches.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->matches[_i] = std::unique_ptr<server::TMatchesJoin_::MatchJoinT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TMatchesJoin> CreateTMatchesJoin(flatbuffers::FlatBufferBuilder &_fbb, const TMatchesJoinT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TMatchesJoinT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _matches = _fbb.CreateVector<flatbuffers::Offset<server::TMatchesJoin_::MatchJoin>> (_o->matches.size(), [](size_t i, _VectorArgs *__va) { return CreateMatchJoin(*__va->__fbb, __va->__o->matches[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTMatchesJoin(
      _fbb,
      _matches);
}
...
inline Dictionary TMatchesJoin::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = matches(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["matches"] = _a; } }
  return _o;
}
...
inline void MatchJoin::UnPackTo(MatchJoinT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = std::unique_ptr<server::TMatchesJoin_::MatchJoin_::AuthenticateResult4T>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<MatchJoin> CreateMatchJoin(flatbuffers::FlatBufferBuilder &_fbb, const MatchJoinT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const MatchJoinT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline flatbuffers::Offset<AuthenticateResult4> CreateAuthenticateResult4(flatbuffers::FlatBufferBuilder &_fbb, const AuthenticateResult4T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const AuthenticateResult4T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _match_id = _o->match_id.empty() ? 0 : _fbb.CreateString(_o->match_id);
  auto _token = _o->token.empty() ? 0 : _fbb.CreateString(_o->token);
  return server::TMatchesJoin_::MatchJoin_::CreateAuthenticateResult4(
      _fbb,
...
inline void TMatches::UnPackTo(TMatchesT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = matches(); if (_e) { _o->matches.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->matches[_i] = std::unique_ptr<server::MatchT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TMatches> CreateTMatches(flatbuffers::FlatBufferBuilder &_fbb, const TMatchesT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TMatchesT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _matches = _fbb.CreateVector<flatbuffers::Offset<server::Match>> (_o->matches.size(), [](size_t i, _VectorArgs *__va) { return CreateMatch(*__va->__fbb, __va->__o->matches[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTMatches(
      _fbb,
      _matches);
}
...
inline flatbuffers::Offset<MatchDataSend> CreateMatchDataSend(flatbuffers::FlatBufferBuilder &_fbb, const MatchDataSendT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const MatchDataSendT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _match_id = _o->match_id.empty() ? 0 : _fbb.CreateString(_o->match_id);
...
inline Dictionary MatchDataSend::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = match_id(); if (_e) _o["match_id"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = op_code(); _o["op_code"] = _e; }
  { auto _e = data(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i); } _o["data"] = _a; } }
  { auto _e = presences(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["presences"] = _a; } }
  return _o;
}
...
inline void MatchData::UnPackTo(MatchDataT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = match_id(); if (_e) _o->match_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = presence(); if (_e) _o->presence = std::unique_ptr<server::UserPresenceT>(_e->UnPack(_resolver)); }
  { auto _e = op_code(); _o->op_code = _e; }
  { auto _e = data(); if (_e) { _o->data.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->data[_i] = _e->Get(_i); } } }
}
...
inline flatbuffers::Offset<MatchData> CreateMatchData(flatbuffers::FlatBufferBuilder &_fbb, const MatchDataT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const MatchDataT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _match_id = _o->match_id.empty() ? 0 : _fbb.CreateString(_o->match_id);
...
inline Dictionary MatchData::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  Dictionary _o ;
  { auto _e = match_id(); if (_e) _o["match_id"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = presence(); if (_e) _o["presence"] = _e->UnPackToDict(_resolver); }
  { auto _e = op_code(); _o["op_code"] = _e; }
  { auto _e = data(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i); } _o["data"] = _a; } }
  return _o;
}
...
inline void TMatchesLeave::UnPackTo(TMatchesLeaveT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = match_ids(); if (_e) { _o->match_ids.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->match_ids[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } } }
}
...
inline flatbuffers::Offset<TMatchesLeave> CreateTMatchesLeave(flatbuffers::FlatBufferBuilder &_fbb, const TMatchesLeaveT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TMatchesLeaveT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _match_ids = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->match_ids.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->match_ids[i]); }, &_va );
  return server::CreateTMatchesLeave(
      _fbb,
      _match_ids);
}
...
inline Dictionary TMatchesLeave::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = match_ids(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } _o["match_ids"] = _a; } }
  return _o;
}
...
inline void TStorageList::UnPackTo(TStorageListT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = user_id(); if (_e) _o->user_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = bucket(); if (_e) _o->bucket = CharString(_e->c_str(), _e->size()); }
  { auto _e = collection(); if (_e) _o->collection = CharString(_e->c_str(), _e->size()); }
  { auto _e = limit(); _o->limit = _e; }
  { auto _e = cursor(); if (_e) _o->cursor = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TStorageList> CreateTStorageList(flatbuffers::FlatBufferBuilder &_fbb, const TStorageListT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TStorageListT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _user_id = _o->user_id.empty() ? 0 : _fbb.CreateString(_o->user_id);
...
inline void TStorageFetch::UnPackTo(TStorageFetchT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = keys(); if (_e) { _o->keys.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->keys[_i] = std::unique_ptr<server::TStorageFetch_::StorageKeyT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TStorageFetch> CreateTStorageFetch(flatbuffers::FlatBufferBuilder &_fbb, const TStorageFetchT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TStorageFetchT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _keys = _fbb.CreateVector<flatbuffers::Offset<server::TStorageFetch_::StorageKey>> (_o->keys.size(), [](size_t i, _VectorArgs *__va) { return CreateStorageKey(*__va->__fbb, __va->__o->keys[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTStorageFetch(
      _fbb,
      _keys);
}
...
inline Dictionary TStorageFetch::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = keys(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["keys"] = _a; } }
  return _o;
}
...
inline void StorageKey::UnPackTo(StorageKeyT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = bucket(); if (_e) _o->bucket = CharString(_e->c_str(), _e->size()); }
  { auto _e = collection(); if (_e) _o->collection = CharString(_e->c_str(), _e->size()); }
  { auto _e = record(); if (_e) _o->record = CharString(_e->c_str(), _e->size()); }
  { auto _e = user_id(); if (_e) _o->user_id = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<StorageKey> CreateStorageKey(flatbuffers::FlatBufferBuilder &_fbb, const StorageKeyT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const StorageKeyT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _bucket = _o->bucket.empty() ? 0 : _fbb.CreateString(_o->bucket);
  auto _collection = _o->collection.empty() ? 0 : _fbb.CreateString(_o->collection);
...
inline void TStorageData::UnPackTo(TStorageDataT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = data(); if (_e) { _o->data.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->data[_i] = std::unique_ptr<server::TStorageData_::StorageDataT>(_e->Get(_i)->UnPack(_resolver)); } } }
  { auto _e = cursor(); if (_e) _o->cursor = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TStorageData> CreateTStorageData(flatbuffers::FlatBufferBuilder &_fbb, const TStorageDataT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TStorageDataT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _data = _fbb.CreateVector<flatbuffers::Offset<server::TStorageData_::StorageData>> (_o->data.size(), [](size_t i, _VectorArgs *__va) { return CreateStorageData(*__va->__fbb, __va->__o->data[i].get(), __va->__rehasher); }, &_va );
  auto _cursor = _o->cursor.empty() ? 0 : _fbb.CreateString(_o->cursor);
  return server::CreateTStorageData(
      _fbb,
      _data,
...
inline Dictionary TStorageData::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = data(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["data"] = _a; } }
  { auto _e = cursor(); if (_e) _o["cursor"] = CharString(_e->c_str(), _e->size()); }
  return _o;
}
...
inline void StorageData::UnPackTo(StorageDataT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = record(); if (_e) _o->record = CharString(_e->c_str(), _e->size()); }
  { auto _e = user_id(); if (_e) _o->user_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = value(); if (_e) _o->value = CharString(_e->c_str(), _e->size()); }
  { auto _e = version(); if (_e) _o->version = CharString(_e->c_str(), _e->size()); }
  { auto _e = permission_read(); _o->permission_read = _e; }
  { auto _e = permission_write(); _o->permission_write = _e; }
  { auto _e = created_at(); _o->created_at = _e; }
  { auto _e = updated_at(); _o->updated_at = _e; }
  { auto _e = expires_at(); _o->expires_at = _e; }
}
...
inline flatbuffers::Offset<StorageData> CreateStorageData(flatbuffers::FlatBufferBuilder &_fbb, const StorageDataT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const StorageDataT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _bucket = _o->bucket.empty() ? 0 : _fbb.CreateString(_o->bucket);
  auto _collection = _o->collection.empty() ? 0 : _fbb.CreateString(_o->collection);
  auto _record = _o->record.empty() ? 0 : _fbb.CreateString(_o->record);
  auto _user_id = _o->user_id.empty() ? 0 : _fbb.CreateString(_o->user_id);
...
inline void TStorageWrite::UnPackTo(TStorageWriteT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = data(); if (_e) { _o->data.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->data[_i] = std::unique_ptr<server::TStorageWrite_::StorageDataT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TStorageWrite> CreateTStorageWrite(flatbuffers::FlatBufferBuilder &_fbb, const TStorageWriteT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TStorageWriteT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _data = _fbb.CreateVector<flatbuffers::Offset<server::TStorageWrite_::StorageData>> (_o->data.size(), [](size_t i, _VectorArgs *__va) { return CreateStorageData(*__va->__fbb, __va->__o->data[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTStorageWrite(
      _fbb,
      _data);
}
...
inline void TStorageUpdate::UnPackTo(TStorageUpdateT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = updates(); if (_e) { _o->updates.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->updates[_i] = std::unique_ptr<server::TStorageUpdate_::StorageUpdateT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TStorageUpdate> CreateTStorageUpdate(flatbuffers::FlatBufferBuilder &_fbb, const TStorageUpdateT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TStorageUpdateT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _updates = _fbb.CreateVector<flatbuffers::Offset<server::TStorageUpdate_::StorageUpdate>> (_o->updates.size(), [](size_t i, _VectorArgs *__va) { return CreateStorageUpdate(*__va->__fbb, __va->__o->updates[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTStorageUpdate(
      _fbb,
      _updates);
}
...
inline Dictionary TStorageUpdate::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = updates(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["updates"] = _a; } }
  return _o;
}
...
inline void StorageUpdate::UnPackTo(StorageUpdateT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = key(); if (_e) _o->key = std::unique_ptr<server::TStorageUpdate_::StorageUpdate_::StorageKeyT>(_e->UnPack(_resolver)); }
  { auto _e = permission_read(); _o->permission_read = _e; }
  { auto _e = permission_write(); _o->permission_write = _e; }
  { auto _e = ops(); if (_e) { _o->ops.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->ops[_i] = std::unique_ptr<server::TStorageUpdate_::StorageUpdate_::UpdateOpT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<StorageUpdate> CreateStorageUpdate(flatbuffers::FlatBufferBuilder &_fbb, const StorageUpdateT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const StorageUpdateT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _key = _o->key ? CreateStorageKey(_fbb, _o->key.get(), _rehasher) : 0;
  auto _permission_read = _o->permission_read;
  auto _permission_write = _o->permission_write;
  auto _ops = _fbb.CreateVector<flatbuffers::Offset<server::TStorageUpdate_::StorageUpdate_::UpdateOp>> (_o->ops.size(), [](size_t i, _VectorArgs *__va) { return CreateUpdateOp(*__va->__fbb, __va->__o->ops[i].get(), __va->__rehasher); }, &_va );
  return server::TStorageUpdate_::CreateStorageUpdate(
      _fbb,
      _key,
      _permission_read,
...
inline Dictionary StorageUpdate::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = key(); if (_e) _o["key"] = _e->UnPackToDict(_resolver); }
  { auto _e = permission_read(); _o["permission_read"] = _e; }
  { auto _e = permission_write(); _o["permission_write"] = _e; }
  { auto _e = ops(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["ops"] = _a; } }
  return _o;
}
...
inline void UpdateOp::UnPackTo(UpdateOpT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = op(); _o->op = _e; }
  { auto _e = path(); if (_e) _o->path = CharString(_e->c_str(), _e->size()); }
  { auto _e = value(); if (_e) _o->value = CharString(_e->c_str(), _e->size()); }
  { auto _e = from(); if (_e) _o->from = CharString(_e->c_str(), _e->size()); }
  { auto _e = conditional(); _o->conditional = _e; }
  { auto _e = assertion(); _o->assertion = _e; }
  { auto _e = ops(); if (_e) { _o->ops.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->ops[_i] = std::unique_ptr<server::TStorageUpdate_::StorageUpdate_::UpdateOpT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<UpdateOp> CreateUpdateOp(flatbuffers::FlatBufferBuilder &_fbb, const UpdateOpT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const UpdateOpT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _op = _o->op;
...
inline void TStorageKeys::UnPackTo(TStorageKeysT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = keys(); if (_e) { _o->keys.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->keys[_i] = std::unique_ptr<server::TStorageKeys_::StorageKeyT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TStorageKeys> CreateTStorageKeys(flatbuffers::FlatBufferBuilder &_fbb, const TStorageKeysT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TStorageKeysT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _keys = _fbb.CreateVector<flatbuffers::Offset<server::TStorageKeys_::StorageKey>> (_o->keys.size(), [](size_t i, _VectorArgs *__va) { return CreateStorageKey(*__va->__fbb, __va->__o->keys[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTStorageKeys(
      _fbb,
      _keys);
}
...
inline void TStorageRemove::UnPackTo(TStorageRemoveT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = keys(); if (_e) { _o->keys.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->keys[_i] = std::unique_ptr<server::TStorageRemove_::StorageKeyT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TStorageRemove> CreateTStorageRemove(flatbuffers::FlatBufferBuilder &_fbb, const TStorageRemoveT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TStorageRemoveT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _keys = _fbb.CreateVector<flatbuffers::Offset<server::TStorageRemove_::StorageKey>> (_o->keys.size(), [](size_t i, _VectorArgs *__va) { return CreateStorageKey(*__va->__fbb, __va->__o->keys[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTStorageRemove(
      _fbb,
      _keys);
}
...
inline void Leaderboard::UnPackTo(LeaderboardT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = sort(); _o->sort = _e; }
  { auto _e = count(); _o->count = _e; }
  { auto _e = reset_schedule(); if (_e) _o->reset_schedule = CharString(_e->c_str(), _e->size()); }
  { auto _e = metadata(); if (_e) _o->metadata = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<Leaderboard> CreateLeaderboard(flatbuffers::FlatBufferBuilder &_fbb, const LeaderboardT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const LeaderboardT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _id = _o->id.empty() ? 0 : _fbb.CreateString(_o->id);
...
inline void LeaderboardRecord::UnPackTo(LeaderboardRecordT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = leaderboard_id(); if (_e) _o->leaderboard_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = owner_id(); if (_e) _o->owner_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = handle(); if (_e) _o->handle = CharString(_e->c_str(), _e->size()); }
  { auto _e = lang(); if (_e) _o->lang = CharString(_e->c_str(), _e->size()); }
  { auto _e = location(); if (_e) _o->location = CharString(_e->c_str(), _e->size()); }
  { auto _e = timezone(); if (_e) _o->timezone = CharString(_e->c_str(), _e->size()); }
  ...
  { auto _e = num_score(); _o->num_score = _e; }
  { auto _e = metadata(); if (_e) _o->metadata = CharString(_e->c_str(), _e->size()); }
  { auto _e = ranked_at(); _o->ranked_at = _e; }
  { auto _e = updated_at(); _o->updated_at = _e; }
  { auto _e = expires_at(); _o->expires_at = _e; }
}
...
inline flatbuffers::Offset<LeaderboardRecord> CreateLeaderboardRecord(flatbuffers::FlatBufferBuilder &_fbb, const LeaderboardRecordT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const LeaderboardRecordT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void TLeaderboardsList::UnPackTo(TLeaderboardsListT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = limit(); _o->limit = _e; }
  { auto _e = cursor(); if (_e) _o->cursor = CharString(_e->c_str(), _e->size()); }
  { auto _e = filter_leaderboard_id(); if (_e) { _o->filter_leaderboard_id.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->filter_leaderboard_id[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } } }
}
...
inline flatbuffers::Offset<TLeaderboardsList> CreateTLeaderboardsList(flatbuffers::FlatBufferBuilder &_fbb, const TLeaderboardsListT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TLeaderboardsListT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _limit = _o->limit;
  auto _cursor = _o->cursor.empty() ? 0 : _fbb.CreateString(_o->cursor);
  auto _filter_leaderboard_id = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->filter_leaderboard_id.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->filter_leaderboard_id[i]); }, &_va );
  return server::CreateTLeaderboardsList(
      _fbb,
      _limit,
      _cursor,
...
inline Dictionary TLeaderboardsList::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = limit(); _o["limit"] = _e; }
  { auto _e = cursor(); if (_e) _o["cursor"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = filter_leaderboard_id(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } _o["filter_leaderboard_id"] = _a; } }
  return _o;
}
...
inline void TLeaderboards::UnPackTo(TLeaderboardsT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = leaderboards(); if (_e) { _o->leaderboards.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->leaderboards[_i] = std::unique_ptr<server::LeaderboardT>(_e->Get(_i)->UnPack(_resolver)); } } }
  { auto _e = cursor(); if (_e) _o->cursor = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TLeaderboards> CreateTLeaderboards(flatbuffers::FlatBufferBuilder &_fbb, const TLeaderboardsT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TLeaderboardsT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _leaderboards = _fbb.CreateVector<flatbuffers::Offset<server::Leaderboard>> (_o->leaderboards.size(), [](size_t i, _VectorArgs *__va) { return CreateLeaderboard(*__va->__fbb, __va->__o->leaderboards[i].get(), __va->__rehasher); }, &_va );
  auto _cursor = _o->cursor.empty() ? 0 : _fbb.CreateString(_o->cursor);
  return server::CreateTLeaderboards(
      _fbb,
      _leaderboards,
...
inline Dictionary TLeaderboards::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = leaderboards(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["leaderboards"] = _a; } }
  { auto _e = cursor(); if (_e) _o["cursor"] = CharString(_e->c_str(), _e->size()); }
  return _o;
}
...
inline void TLeaderboardRecordsWrite::UnPackTo(TLeaderboardRecordsWriteT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = records(); if (_e) { _o->records.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->records[_i] = std::unique_ptr<server::TLeaderboardRecordsWrite_::LeaderboardRecordWriteT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<TLeaderboardRecordsWrite> CreateTLeaderboardRecordsWrite(flatbuffers::FlatBufferBuilder &_fbb, const TLeaderboardRecordsWriteT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TLeaderboardRecordsWriteT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _records = _fbb.CreateVector<flatbuffers::Offset<server::TLeaderboardRecordsWrite_::LeaderboardRecordWrite>> (_o->records.size(), [](size_t i, _VectorArgs *__va) { return CreateLeaderboardRecordWrite(*__va->__fbb, __va->__o->records[i].get(), __va->__rehasher); }, &_va );
  return server::CreateTLeaderboardRecordsWrite(
      _fbb,
      _records);
}
...
inline Dictionary TLeaderboardRecordsWrite::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = records(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["records"] = _a; } }
  return _o;
}
...
inline void LeaderboardRecordWrite::UnPackTo(LeaderboardRecordWriteT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = leaderboard_id(); if (_e) _o->leaderboard_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = op(); if (_e) _o->op = std::unique_ptr<server::TLeaderboardRecordsWrite_::LeaderboardRecordWrite_::ScoreOperatorT>(_e->UnPack(_resolver)); }
  { auto _e = location(); if (_e) _o->location = CharString(_e->c_str(), _e->size()); }
  { auto _e = timezone(); if (_e) _o->timezone = CharString(_e->c_str(), _e->size()); }
  { auto _e = metadata(); if (_e) _o->metadata = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<LeaderboardRecordWrite> CreateLeaderboardRecordWrite(flatbuffers::FlatBufferBuilder &_fbb, const LeaderboardRecordWriteT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const LeaderboardRecordWriteT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _leaderboard_id = _o->leaderboard_id.empty() ? 0 : _fbb.CreateString(_o->leaderboard_id);
...
inline Dictionary LeaderboardRecordWrite::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  Dictionary _o ;
  { auto _e = leaderboard_id(); if (_e) _o["leaderboard_id"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = op(); if (_e) _o["op"] = _e->UnPackToDict(_resolver); }
  { auto _e = location(); if (_e) _o["location"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = timezone(); if (_e) _o["timezone"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = metadata(); if (_e) _o["metadata"] = CharString(_e->c_str(), _e->size()); }
  return _o;
...
inline void ScoreOperator::UnPackTo(ScoreOperatorT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = incr(); _o->incr = _e; }
  { auto _e = decr(); _o->decr = _e; }
  { auto _e = set(); _o->set = _e; }
  { auto _e = best(); _o->best = _e; }
}
...
inline flatbuffers::Offset<ScoreOperator> CreateScoreOperator(flatbuffers::FlatBufferBuilder &_fbb, const ScoreOperatorT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const ScoreOperatorT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _incr = _o->incr;
  auto _decr = _o->decr;
  auto _set = _o->set;
  auto _best = _o->best;
...
inline void TLeaderboardRecordsFetch::UnPackTo(TLeaderboardRecordsFetchT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = leaderboard_ids(); if (_e) { _o->leaderboard_ids.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->leaderboard_ids[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } } }
  { auto _e = limit(); _o->limit = _e; }
  { auto _e = cursor(); if (_e) _o->cursor = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TLeaderboardRecordsFetch> CreateTLeaderboardRecordsFetch(flatbuffers::FlatBufferBuilder &_fbb, const TLeaderboardRecordsFetchT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TLeaderboardRecordsFetchT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _leaderboard_ids = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->leaderboard_ids.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->leaderboard_ids[i]); }, &_va );
  auto _limit = _o->limit;
  auto _cursor = _o->cursor.empty() ? 0 : _fbb.CreateString(_o->cursor);
  return server::CreateTLeaderboardRecordsFetch(
      _fbb,
...
inline Dictionary TLeaderboardRecordsFetch::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = leaderboard_ids(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } _o["leaderboard_ids"] = _a; } }
  { auto _e = limit(); _o["limit"] = _e; }
  { auto _e = cursor(); if (_e) _o["cursor"] = CharString(_e->c_str(), _e->size()); }
  return _o;
}
...
inline void TLeaderboardRecordsList::UnPackTo(TLeaderboardRecordsListT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = leaderboard_id(); if (_e) _o->leaderboard_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = filter(); if (_e) _o->filter = std::unique_ptr<server::TLeaderboardRecordsList_::AuthenticateResult6T>(_e->UnPack(_resolver)); }
  { auto _e = limit(); _o->limit = _e; }
  { auto _e = cursor(); if (_e) _o->cursor = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TLeaderboardRecordsList> CreateTLeaderboardRecordsList(flatbuffers::FlatBufferBuilder &_fbb, const TLeaderboardRecordsListT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TLeaderboardRecordsListT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _leaderboard_id = _o->leaderboard_id.empty() ? 0 : _fbb.CreateString(_o->leaderboard_id);
...
inline void Owners::UnPackTo(OwnersT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = owner_ids(); if (_e) { _o->owner_ids.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->owner_ids[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } } }
}
...
inline flatbuffers::Offset<Owners> CreateOwners(flatbuffers::FlatBufferBuilder &_fbb, const OwnersT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const OwnersT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _owner_ids = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->owner_ids.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->owner_ids[i]); }, &_va );
  return server::TLeaderboardRecordsList_::CreateOwners(
      _fbb,
      _owner_ids);
}
...
inline Dictionary Owners::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = owner_ids(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } _o["owner_ids"] = _a; } }
  return _o;
}
...
inline void AuthenticateResult6::UnPackTo(AuthenticateResult6T *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = owner_id(); if (_e) _o->owner_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = owner_ids(); if (_e) _o->owner_ids = std::unique_ptr<server::TLeaderboardRecordsList_::OwnersT>(_e->UnPack(_resolver)); }
  { auto _e = lang(); if (_e) _o->lang = CharString(_e->c_str(), _e->size()); }
  { auto _e = location(); if (_e) _o->location = CharString(_e->c_str(), _e->size()); }
  { auto _e = timezone(); if (_e) _o->timezone = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<AuthenticateResult6> CreateAuthenticateResult6(flatbuffers::FlatBufferBuilder &_fbb, const AuthenticateResult6T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const AuthenticateResult6T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _owner_id = _o->owner_id.empty() ? 0 : _fbb.CreateString(_o->owner_id);
...
inline Dictionary AuthenticateResult6::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  ...
  Dictionary _o ;
  { auto _e = owner_id(); if (_e) _o["owner_id"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = owner_ids(); if (_e) _o["owner_ids"] = _e->UnPackToDict(_resolver); }
  { auto _e = lang(); if (_e) _o["lang"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = location(); if (_e) _o["location"] = CharString(_e->c_str(), _e->size()); }
  { auto _e = timezone(); if (_e) _o["timezone"] = CharString(_e->c_str(), _e->size()); }
  return _o;
...
inline void TLeaderboardRecords::UnPackTo(TLeaderboardRecordsT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = records(); if (_e) { _o->records.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->records[_i] = std::unique_ptr<server::LeaderboardRecordT>(_e->Get(_i)->UnPack(_resolver)); } } }
  { auto _e = cursor(); if (_e) _o->cursor = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TLeaderboardRecords> CreateTLeaderboardRecords(flatbuffers::FlatBufferBuilder &_fbb, const TLeaderboardRecordsT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TLeaderboardRecordsT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _records = _fbb.CreateVector<flatbuffers::Offset<server::LeaderboardRecord>> (_o->records.size(), [](size_t i, _VectorArgs *__va) { return CreateLeaderboardRecord(*__va->__fbb, __va->__o->records[i].get(), __va->__rehasher); }, &_va );
  auto _cursor = _o->cursor.empty() ? 0 : _fbb.CreateString(_o->cursor);
  return server::CreateTLeaderboardRecords(
      _fbb,
      _records,
...
inline void TRpc::UnPackTo(TRpcT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = CharString(_e->c_str(), _e->size()); }
  { auto _e = payload(); if (_e) _o->payload = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TRpc> CreateTRpc(flatbuffers::FlatBufferBuilder &_fbb, const TRpcT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TRpcT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _id = _o->id.empty() ? 0 : _fbb.CreateString(_o->id);
...
inline void TPurchaseValidation::UnPackTo(TPurchaseValidationT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = std::unique_ptr<server::TPurchaseValidation_::AuthenticateResult7T>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<TPurchaseValidation> CreateTPurchaseValidation(flatbuffers::FlatBufferBuilder &_fbb, const TPurchaseValidationT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TPurchaseValidationT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void ApplePurchase::UnPackTo(ApplePurchaseT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = product_id(); if (_e) _o->product_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = receipt_data(); if (_e) _o->receipt_data = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<ApplePurchase> CreateApplePurchase(flatbuffers::FlatBufferBuilder &_fbb, const ApplePurchaseT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const ApplePurchaseT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void GooglePurchase::UnPackTo(GooglePurchaseT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = product_id(); if (_e) _o->product_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = product_type(); if (_e) _o->product_type = CharString(_e->c_str(), _e->size()); }
  { auto _e = purchase_token(); if (_e) _o->purchase_token = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<GooglePurchase> CreateGooglePurchase(flatbuffers::FlatBufferBuilder &_fbb, const GooglePurchaseT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const GooglePurchaseT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _product_id = _o->product_id.empty() ? 0 : _fbb.CreateString(_o->product_id);
...
inline void AuthenticateResult7::UnPackTo(AuthenticateResult7T *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = apple_purchase(); if (_e) _o->apple_purchase = std::unique_ptr<server::TPurchaseValidation_::ApplePurchaseT>(_e->UnPack(_resolver)); }
  { auto _e = google_purchase(); if (_e) _o->google_purchase = std::unique_ptr<server::TPurchaseValidation_::GooglePurchaseT>(_e->UnPack(_resolver)); }
}
...
inline flatbuffers::Offset<AuthenticateResult7> CreateAuthenticateResult7(flatbuffers::FlatBufferBuilder &_fbb, const AuthenticateResult7T *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const AuthenticateResult7T* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline Dictionary AuthenticateResult7::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = apple_purchase(); if (_e) _o["apple_purchase"] = _e->UnPackToDict(_resolver); }
  { auto _e = google_purchase(); if (_e) _o["google_purchase"] = _e->UnPackToDict(_resolver); }
  return _o;
}
...
inline void TPurchaseRecord::UnPackTo(TPurchaseRecordT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  { auto _e = seen_before(); _o->seen_before = _e; }
  { auto _e = purchase_provider_reachable(); _o->purchase_provider_reachable = _e; }
  { auto _e = message(); if (_e) _o->message = CharString(_e->c_str(), _e->size()); }
  { auto _e = data(); if (_e) _o->data = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TPurchaseRecord> CreateTPurchaseRecord(flatbuffers::FlatBufferBuilder &_fbb, const TPurchaseRecordT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TPurchaseRecordT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
...
inline void Notification::UnPackTo(NotificationT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = id(); if (_e) _o->id = CharString(_e->c_str(), _e->size()); }
  { auto _e = subject(); if (_e) _o->subject = CharString(_e->c_str(), _e->size()); }
  { auto _e = content(); if (_e) _o->content = CharString(_e->c_str(), _e->size()); }
  { auto _e = code(); _o->code = _e; }
  { auto _e = sender_id(); if (_e) _o->sender_id = CharString(_e->c_str(), _e->size()); }
  { auto _e = created_at(); _o->created_at = _e; }
  { auto _e = expires_at(); _o->expires_at = _e; }
  { auto _e = persistent(); _o->persistent = _e; }
}
...
inline void Notifications::UnPackTo(NotificationsT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = notifications(); if (_e) { _o->notifications.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->notifications[_i] = std::unique_ptr<server::NotificationT>(_e->Get(_i)->UnPack(_resolver)); } } }
}
...
inline flatbuffers::Offset<Notifications> CreateNotifications(flatbuffers::FlatBufferBuilder &_fbb, const NotificationsT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const NotificationsT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _notifications = _fbb.CreateVector<flatbuffers::Offset<server::Notification>> (_o->notifications.size(), [](size_t i, _VectorArgs *__va) { return CreateNotification(*__va->__fbb, __va->__o->notifications[i].get(), __va->__rehasher); }, &_va );
  return server::CreateNotifications(
      _fbb,
      _notifications);
}
...
inline Dictionary Notifications::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = notifications(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = _e->Get(_i)->UnPackToDict(_resolver); } _o["notifications"] = _a; } }
  return _o;
}
...
inline void TNotificationsList::UnPackTo(TNotificationsListT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  ...
  (void)_resolver;
  { auto _e = limit(); _o->limit = _e; }
  { auto _e = resumable_cursor(); if (_e) _o->resumable_cursor = CharString(_e->c_str(), _e->size()); }
}
...
inline flatbuffers::Offset<TNotificationsList> CreateTNotificationsList(flatbuffers::FlatBufferBuilder &_fbb, const TNotificationsListT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TNotificationsListT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _limit = _o->limit;
...
inline flatbuffers::Offset<TNotifications> CreateTNotifications(flatbuffers::FlatBufferBuilder &_fbb, const TNotificationsT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TNotificationsT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _notifications = _fbb.CreateVector<flatbuffers::Offset<server::Notification>> (_o->notifications.size(), [](size_t i, _VectorArgs *__va) { return CreateNotification(*__va->__fbb, __va->__o->notifications[i].get(), __va->__rehasher); }, &_va );
  auto _resumable_cursor = _o->resumable_cursor.empty() ? 0 : _fbb.CreateString(_o->resumable_cursor);
  return server::CreateTNotifications(
      _fbb,
...
inline void TNotificationsRemove::UnPackTo(TNotificationsRemoveT *_o, const flatbuffers::resolver_function_t *_resolver) const {
  (void)_o;
  (void)_resolver;
  { auto _e = notification_ids(); if (_e) { _o->notification_ids.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _o->notification_ids[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } } }
}
...
inline flatbuffers::Offset<TNotificationsRemove> CreateTNotificationsRemove(flatbuffers::FlatBufferBuilder &_fbb, const TNotificationsRemoveT *_o, const flatbuffers::rehasher_function_t *_rehasher) {
  (void)_rehasher;
  (void)_o;
  struct _VectorArgs { flatbuffers::FlatBufferBuilder *__fbb; const TNotificationsRemoveT* __o; const flatbuffers::rehasher_function_t *__rehasher; } _va = { &_fbb, _o, _rehasher}; (void)_va;
  auto _notification_ids = _fbb.CreateVector<flatbuffers::Offset<flatbuffers::String>> (_o->notification_ids.size(), [](size_t i, _VectorArgs *__va) { return __va->__fbb->CreateString(__va->__o->notification_ids[i]); }, &_va );
  return server::CreateTNotificationsRemove(
      _fbb,
      _notification_ids);
}
...
inline Dictionary TNotificationsRemove::UnPackToDict(const flatbuffers::resolver_function_t *_resolver) const {
  (void)_resolver;
  Dictionary _o ;
  { auto _e = notification_ids(); if (_e) { Array _a; _a.resize(_e->size()); for (flatbuffers::uoffset_t _i = 0; _i < _e->size(); _i++) { _a[_i] = CharString(_e->Get(_i)->c_str(), _e->Get(_i)->size()); } _o["notification_ids"] = _a; } }
  return _o;
}
