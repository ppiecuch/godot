...
#ifndef LIBLDR_ELEMENTS_H
#define LIBLDR_ELEMENTS_H
...
// Colored element
class element_colored_base : public element_base
{
	color m_color;
...
class element_comment : public element_base
{
	std::string m_str;
...
// status definition
class element_state : public element_base
{
	state m_state;
...
class element_print : public element_base
{
	std::string m_str;
...
class element_ref : public element_colored_base
{
	friend class model;
...
// Line
class element_line : public element_colored_base
{
...
// Triangle
class element_triangle : public element_colored_base
{
...
// Quadrilateral
class element_quadrilateral : public element_colored_base
{
...
// Conditional line.
class element_condline : public element_colored_base
{
	vector m_pos1, m_pos2, m_pos3, m_pos4;
public:
	vector& pos1() { return m_pos1; }
