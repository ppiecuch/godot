...
public:
	...
	VNCSockets(uint32_t IPAddr, uint16_t _port); ///< constructors
...
#if _DEBUG
	void PrintInHex(char *buf, int len); ///< Print out the contents of a packet for debugging.
#endif
};
