...
public:
	int entity_count = 0;
	LMEntity *entities = nullptr;
	LMEntityGeometry *entity_geo = nullptr;

	int texture_count = 0;
	LMTextureData *textures = nullptr;

	int worldspawn_layer_count = 0;
	LMWorldspawnLayer *worldspawn_layers = nullptr;
