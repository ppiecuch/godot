...
class SkinSurfaceGenerator : public Generator {
 ...
 private:
  PipelineStageInfo info{PipelineStageNames_Gen[PipelineStage_Gen_SkinSurface], "Generates a skin surface.", PipelineStageType::Generator, PipelineStage_Gen_SkinSurface};
};
}  // namespace procrock
