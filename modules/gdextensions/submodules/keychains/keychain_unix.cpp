...
/**************************************************************************/
/* Linux keychain backend using libsecret (FreeDesktop Secret Service).   */
/* Uses dlopen/dlsym for runtime loading — no build-time dependency.      */
/* Falls back to NO_BACKEND_AVAILABLE if libsecret is not installed.      */
/**************************************************************************/
