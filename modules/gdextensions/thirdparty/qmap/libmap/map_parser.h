#ifndef LIBMAP_MAP_PARSER_H
#define LIBMAP_MAP_PARSER_H

#include "libmap/brush.h"
#include "libmap/entity.h"
#include "libmap/face.h"
...
public:
	...
	void commit_brush();
	void commit_entity();
	LMMapParser(std::shared_ptr<LMMapData> _map_data) : map_data(_map_data){};
};

#endif // LIBMAP_MAP_PARSER_H
