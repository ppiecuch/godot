...
struct Configuration {
  struct Entry {
    ...
    Entry(std::string name, std::string description, std::function<bool()> active) : name(name), description(description), active(active) { }
    Entry(std::string name, std::string description) : name(name), description(description) { }
    Entry() { }
  };
