...
TransformationModifier::TransformationModifier() {
  ...
  group.float3s.emplace_back(Configuration::BoundedEntry<Eigen::Vector3f>{{"Translation", "Translate the rock."}, &translation, {-2, -2, -2}, {2, 2, 2}});
  group.float3s.emplace_back(Configuration::BoundedEntry<Eigen::Vector3f>{{"Scale", "Scale the rock."}, &scale, {0, 0, 0}, {3, 3, 3}});
  group.float3s.emplace_back(Configuration::BoundedEntry<Eigen::Vector3f>{{"Rotate", "Rotate the rock."}, &rotation, {0, 0, 0}, {2 * M_PI, 2 * M_PI, 2 * M_PI}});
