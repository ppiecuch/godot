...
/**************************************************************************/
/* Android keychain backend using Android KeyStore with RSA encryption.   */
/* Encrypted blobs are stored via the plaintext fallback ConfigFile.      */
/* Requires API 18+ (KeyPairGeneratorSpec).                               */
/**************************************************************************/
