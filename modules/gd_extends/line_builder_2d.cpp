...
void LineBuilder2D::set_default_color(const Color &p_default_color) { lb.default_color = p_default_color; }
Color LineBuilder2D::get_default_color() const { return lb.default_color; }
void LineBuilder2D::set_gradient(Ref<Gradient> p_gradient) { lb.gradient = *p_gradient; }
Ref<Gradient> LineBuilder2D::get_gradient() const { return lb.gradient; }
void LineBuilder2D::set_texture_mode(Line2D::LineTextureMode p_texture_mode) { lb.texture_mode = p_texture_mode; }
...
void LineBuilder2D::set_end_cap_mode(Line2D::LineCapMode p_end_cap_mode) { lb.end_cap_mode = p_end_cap_mode; }
Line2D::LineCapMode LineBuilder2D::get_end_cap_mode() const { return lb.end_cap_mode; }
void LineBuilder2D::set_round_precision(int p_round_precision) { lb.round_precision = p_round_precision; }
int LineBuilder2D::get_round_precision() const { return lb.round_precision; }
void LineBuilder2D::set_sharp_limit(real_t p_sharp_limit) { lb.sharp_limit = p_sharp_limit; }
real_t LineBuilder2D::get_sharp_limit() const { return lb.sharp_limit; }
void LineBuilder2D::set_width(float p_width) { lb.width = p_width; }
float LineBuilder2D::get_width() const { return lb.width; }
void LineBuilder2D::set_curve(Ref<Curve> p_curve) { lb.curve = *p_curve; }
